...
public final class EventLoopKt {
    ...
    public static final long processNextEventInCurrentThread() {
        ...
        return eventLoopCurrentOrNull$kotlinx_coroutines_core == null ? LongCompanionObject.MAX_VALUE : eventLoopCurrentOrNull$kotlinx_coroutines_core.processNextEvent();
    }
}
