    ...
    public boolean tryEmit(T value) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m77constructorimpl(unit));
            }
        }
        return z;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Unit unit = Unit.INSTANCE;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m77constructorimpl(unit));
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m77constructorimpl(unit2));
            }
        }
