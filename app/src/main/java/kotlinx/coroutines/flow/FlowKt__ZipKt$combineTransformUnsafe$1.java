...
public final class FlowKt__ZipKt$combineTransformUnsafe$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            if (CombineKt.combineInternal((FlowCollector) this.L$0, this.$flows, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new AnonymousClass1(this.$transform, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        InlineMarker.mark(0);
        CombineKt.combineInternal((FlowCollector) this.L$0, this.$flows, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new AnonymousClass1(this.$transform, null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
