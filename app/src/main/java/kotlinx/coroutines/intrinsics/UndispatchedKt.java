        ...
        try {
            if (function1 != null) {
                ...
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m77constructorimpl(objInvoke));
                    return;
                }
                return;
            }
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m77constructorimpl(ResultKt.createFailure(th)));
        }
    }
