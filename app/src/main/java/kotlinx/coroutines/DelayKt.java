    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1579scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1519delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1520toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1520toDelayMillisLRDsOJo(long j) {
        if (Duration.m1378compareToLRDsOJo(j, Duration.INSTANCE.m1481getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1426toLongMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
