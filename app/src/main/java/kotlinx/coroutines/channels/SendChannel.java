...
public interface SendChannel<E> {
    ...
    Object mo1534trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1549isSuccessimpl(objMo1534trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1543exceptionOrNullimpl = ChannelResult.m1543exceptionOrNullimpl(objMo1534trySendJP2dKIU);
