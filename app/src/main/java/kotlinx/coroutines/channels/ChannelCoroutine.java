...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1532receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1532receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1533tryReceivePtdJZtk() {
        return this._channel.mo1533tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1534trySendJP2dKIU(E element) {
        return this._channel.mo1534trySendJP2dKIU(element);
    }
