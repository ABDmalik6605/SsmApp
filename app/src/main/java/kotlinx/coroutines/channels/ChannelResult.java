...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1539boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1540constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m1546hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m1541equalsimpl(getHolder(), obj);
    }

    public int hashCode() {
        return m1546hashCodeimpl(getHolder());
    }
    ...
    public static final boolean m1549isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m1548isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m1547isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m1544getOrNullimpl(Object obj) {
    ...
    public static final T m1545getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1543exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1554successJP2dKIU(E value) {
            return ChannelResult.m1540constructorimpl(value);
        }

        /* renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m1553failurePtdJZtk() {
            return ChannelResult.m1540constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m1552closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1540constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m1550toStringimpl(getHolder());
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1550toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
