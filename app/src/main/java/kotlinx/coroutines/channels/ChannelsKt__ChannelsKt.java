...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1549isSuccessimpl(sendChannel.mo1534trySendJP2dKIU(e))) {
            return;
        }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM77constructorimpl = Result.m77constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1539boximpl(Result.m84isSuccessimpl(objM77constructorimpl) ? ChannelResult.INSTANCE.m1554successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1552closedJP2dKIU(Result.m80exceptionOrNullimpl(objM77constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        Object objMo1534trySendJP2dKIU = sendChannel.mo1534trySendJP2dKIU(e);
        if (objMo1534trySendJP2dKIU instanceof ChannelResult.Failed) {
