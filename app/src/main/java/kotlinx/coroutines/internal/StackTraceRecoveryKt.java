...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM77constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m80exceptionOrNullimpl(objM77constructorimpl) == null) {
            obj2 = objM77constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM77constructorimpl2 = Result.m77constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM77constructorimpl2 = Result.m77constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m80exceptionOrNullimpl(objM77constructorimpl2) == null) {
            obj = objM77constructorimpl2;
        }
