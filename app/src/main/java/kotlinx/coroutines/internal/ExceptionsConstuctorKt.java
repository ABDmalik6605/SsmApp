...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM77constructorimpl = Result.m77constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
            }
            return (E) (Result.m83isFailureimpl(objM77constructorimpl) ? null : objM77constructorimpl);
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        Result.Companion companion2 = Result.INSTANCE;
                        objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th2));
                    }
                    if (objNewInstance != null) {
                        Throwable th3 = (Throwable) objNewInstance;
                        th3.initCause(th);
                        objM77constructorimpl = Result.m77constructorimpl(th3);
                        if (Result.m83isFailureimpl(objM77constructorimpl)) {
                            objM77constructorimpl = null;
                        }
                        return (Throwable) objM77constructorimpl;
                    }
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (objNewInstance != null) {
                            objM77constructorimpl = Result.m77constructorimpl((Throwable) objNewInstance);
                            if (Result.m83isFailureimpl(objM77constructorimpl)) {
                                objM77constructorimpl = null;
                            }
                            return (Throwable) objM77constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM77constructorimpl = Result.m77constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m83isFailureimpl(objM77constructorimpl)) {
            objM77constructorimpl = numValueOf;
        }
        return ((Number) objM77constructorimpl).intValue();
    }
