...
public class LockFreeLinkedListNode {
    ...
    public final /* synthetic */ Object removeFirstIfIsInstanceOfOrPeekIf(Function1 predicate) {
        ...
        while (true) {
            ...
            if ((((Boolean) predicate.invoke(lockFreeLinkedListNode)).booleanValue() && !lockFreeLinkedListNode.isRemoved()) || (lockFreeLinkedListNodeRemoveOrNext = lockFreeLinkedListNode.removeOrNext()) == null) {
                return lockFreeLinkedListNode;
            }
