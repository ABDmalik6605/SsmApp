...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM77constructorimpl = Result.m77constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m83isFailureimpl(objM77constructorimpl) ? null : objM77constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.-$$Lambda$AgentPremain$8e1eAWGNJu9vYr96rU9gzKJ_uMQ
                public final void handle(Signal signal) {
                    AgentPremain.m1556installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1556installSignalHandler$lambda1(Signal signal) {
