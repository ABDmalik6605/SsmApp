...
public final class ThreadPoolDispatcher extends ExecutorCoroutineDispatcherBase {
    ...
    public ThreadPoolDispatcher(int i, String str) {
        this.nThreads = i;
        this.name = str;
        this.executor = Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.-$$Lambda$ThreadPoolDispatcher$W24uUimg9kaJilc37Etkfwyjyfs
            @Override // java.util.concurrent.ThreadFactory
            public final Thread newThread(Runnable runnable) {
                return ThreadPoolDispatcher.m1527executor$lambda0(this.f$0, runnable);
            }
        });
    ...
    public static final Thread m1527executor$lambda0(ThreadPoolDispatcher threadPoolDispatcher, Runnable runnable) {
        String str;
