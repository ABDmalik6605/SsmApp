...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM77constructorimpl = Result.m77constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM77constructorimpl = Result.m77constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m83isFailureimpl(objM77constructorimpl) ? null : objM77constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1578dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerDispatcherKt$Z1vOW_gMqzuAA1kBf19jmX0gPxw
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1530postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1530postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
        Dispatchers dispatchers = Dispatchers.INSTANCE;
