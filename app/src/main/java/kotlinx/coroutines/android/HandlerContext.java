...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1579scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        ...
        this.handler.postDelayed(runnable, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS));
