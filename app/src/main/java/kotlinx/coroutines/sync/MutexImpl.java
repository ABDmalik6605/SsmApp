...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    public <R> void registerSelectClause2(SelectInstance<? super R> select, Object owner, Function2<? super Mutex, ? super Continuation<? super R>, ? extends Object> block) {
        while (!select.isSelected()) {
            ...
            if (obj instanceof Empty) {
                ...
                while (true) {
                    int iTryCondAddNext = lockFreeLinkedListNode.getPrevNode().tryCondAddNext(lockSelect2, lockFreeLinkedListNode, condAddOp);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:31:0x008a, code lost:
        ...
        if (r11 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L33;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x0093, code lost:
        ...
        if (r11 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L36;
     */
    ...
    */
    public final java.lang.Object lockSuspend(final java.lang.Object r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        /*
            r10 = this;
        ...
        L3a:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = kotlinx.coroutines.sync.MutexImpl._state$FU
            boolean r3 = r5.compareAndSet(r10, r3, r4)
            if (r3 == 0) goto L10
        ...
        L96:
            ...
            return r11
        L99:
            java.lang.String r12 = "Already locked by "
