...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo10clone = transition.mo10clone();
        transitionMo10clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo10clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo10clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo10clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo10clone = transition.mo10clone();
        sceneChangeSetup(viewGroup, transitionMo10clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo10clone);
    }
