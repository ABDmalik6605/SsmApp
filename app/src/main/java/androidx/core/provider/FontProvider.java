...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            String[] strArr = {IBMatcherDatabase.COLUMN_NAME__ID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                int columnIndex2 = cursorQuery.getColumnIndex(IBMatcherDatabase.COLUMN_NAME__ID);
