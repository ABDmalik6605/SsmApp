...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(simpleName, "WindowMetricsCalculatorCompat::class.java.simpleName");
        TAG = simpleName;
    }

    @Override // androidx.window.WindowMetricsCalculator
    ...
    @Override // androidx.window.WindowMetricsCalculator
    public WindowMetrics computeMaximumWindowMetrics(Activity activity) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Rect rect;
        Intrinsics.checkNotNullParameter(activity, "activity");
        if (Build.VERSION.SDK_INT >= 30) {
    ...
    public final Rect computeWindowBoundsN$window_release(Activity activity) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(activity, "activity");
        Rect rect = new Rect();
    ...
    public final Rect computeWindowBoundsIceCreamSandwich$window_release(Activity activity) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(activity, "activity");
        Display defaultDisplay = activity.getWindowManager().getDefaultDisplay();
        Intrinsics.checkNotNullExpressionValue(defaultDisplay, "defaultDisplay");
        Point realSizeForDisplay$window_release = getRealSizeForDisplay$window_release(defaultDisplay);
    ...
    public final Point getRealSizeForDisplay$window_release(Display display) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
