...
public class Debug {
    ...
    public static void dumpPoc(Object obj) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) && ((!(obj2 instanceof Integer) || !obj2.toString().equals(Constant.ECE_Katchi)) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getName(Context context, int[] id2) throws Resources.NotFoundException {
        ...
        try {
            ...
            while (i < id2.length) {
                ...
                try {
                    resourceEntryName = context.getResources().getResourceEntryName(id2[i]);
                } catch (Resources.NotFoundException unused) {
                    resourceEntryName = "? " + id2[i] + " ";
                }
