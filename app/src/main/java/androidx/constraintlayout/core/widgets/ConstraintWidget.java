...
public class ConstraintWidget {
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeSize(sb, SimpleMonthView.VIEW_PARAMS_HEIGHT, this.mHeight, this.mMinHeight, this.mMaxDimension[1], this.mHeightOverride, this.mMatchConstraintMinHeight, this.mMatchConstraintDefaultHeight, this.mMatchConstraintPercentHeight, this.mWeight[1]);
