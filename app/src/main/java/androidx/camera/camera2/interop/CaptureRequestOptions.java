...
public class CaptureRequestOptions implements ReadableConfig {
    ...
    public static final class Builder implements ExtendableBuilder<CaptureRequestOptions> {
        ...
        public static Builder from(final Config config) {
            ...
            config.findOptions(Camera2ImplConfig.CAPTURE_REQUEST_ID_STEM, new Config.OptionMatcher() { // from class: androidx.camera.camera2.interop.-$$Lambda$CaptureRequestOptions$Builder$-6TccgEDUqVaPsU9uz_jhFJ869g
