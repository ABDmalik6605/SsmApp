...
public class SelectResolutionQuirk implements Quirk {
    ...
    public Size selectResolution(SurfaceConfig.ConfigType configType) {
    ...
    /* renamed from: androidx.camera.camera2.internal.compat.quirk.SelectResolutionQuirk$1, reason: invalid class name */
