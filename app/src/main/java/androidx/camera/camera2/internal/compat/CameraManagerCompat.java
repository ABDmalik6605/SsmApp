...
public final class CameraManagerCompat {
    ...
    static final class AvailabilityCallbackExecutorWrapper extends CameraManager.AvailabilityCallback {
        ...
        public void onCameraAccessPrioritiesChanged() {
            synchronized (this.mLock) {
                if (!this.mDisabled) {
                    this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.compat.-$$Lambda$CameraManagerCompat$AvailabilityCallbackExecutorWrapper$56FTf5EKACVzet6KPCuIRXgw1Vo
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onCameraAccessPrioritiesChanged$0$CameraManagerCompat$AvailabilityCallbackExecutorWrapper();
                        }
                    });
                }
            }
        ...
        public /* synthetic */ void lambda$onCameraAccessPrioritiesChanged$0$CameraManagerCompat$AvailabilityCallbackExecutorWrapper() {
        ...
        public void onCameraAvailable(final String str) {
            synchronized (this.mLock) {
                if (!this.mDisabled) {
                    this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.compat.-$$Lambda$CameraManagerCompat$AvailabilityCallbackExecutorWrapper$KpgS7AIbmFNiaGs-1pVigV7EgbE
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onCameraAvailable$1$CameraManagerCompat$AvailabilityCallbackExecutorWrapper(str);
                        }
                    });
                }
            }
        ...
        public /* synthetic */ void lambda$onCameraAvailable$1$CameraManagerCompat$AvailabilityCallbackExecutorWrapper(String str) {
        ...
        public void onCameraUnavailable(final String str) {
            synchronized (this.mLock) {
                if (!this.mDisabled) {
                    this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.compat.-$$Lambda$CameraManagerCompat$AvailabilityCallbackExecutorWrapper$aa-E8e61WmNzAJjm3siG1mUQx1Y
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onCameraUnavailable$2$CameraManagerCompat$AvailabilityCallbackExecutorWrapper(str);
                        }
                    });
                }
            }
        ...
        public /* synthetic */ void lambda$onCameraUnavailable$2$CameraManagerCompat$AvailabilityCallbackExecutorWrapper(String str) {
