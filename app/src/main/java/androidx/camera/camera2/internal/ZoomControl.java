...
final class ZoomControl {
    ...
    ListenableFuture<Void> setZoomRatio(float f) {
        ...
        updateLiveData(zoomStateCreate);
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$ZoomControl$GiLzHD_nkj-QPY-IFBQBJ3D_J6E
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$setZoomRatio$1$ZoomControl(zoomStateCreate, completer);
            }
        });
    }

    public /* synthetic */ Object lambda$setZoomRatio$1$ZoomControl(final ZoomState zoomState, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ZoomControl$3uBVx-WShwPZOWDk95H6YDsX5WI
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setZoomRatio$0$ZoomControl(completer, zoomState);
            }
        });
        return "setZoomRatio";
    }
    ...
    ListenableFuture<Void> setLinearZoom(float f) {
        ...
        updateLiveData(zoomStateCreate);
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$ZoomControl$bmGp-2OTZZEUcd34MrQJzOp0bgU
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$setLinearZoom$3$ZoomControl(zoomStateCreate, completer);
            }
        });
    }

    public /* synthetic */ Object lambda$setLinearZoom$3$ZoomControl(final ZoomState zoomState, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ZoomControl$xLz__VFllSz4KDI9gEmaghs7_dI
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setLinearZoom$2$ZoomControl(completer, zoomState);
            }
        });
