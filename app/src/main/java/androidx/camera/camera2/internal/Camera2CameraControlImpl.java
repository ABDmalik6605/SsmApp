...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    Camera2CameraControlImpl(CameraCharacteristicsCompat cameraCharacteristicsCompat, ScheduledExecutorService scheduledExecutorService, Executor executor, CameraControlInternal.ControlUpdateCallback controlUpdateCallback, Quirks quirks) {
        ...
        executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$EJHPcz3GoKV40sz3_ju7RabkiRs
            ...
            public final void run() {
                this.f$0.lambda$new$0$Camera2CameraControlImpl();
            }
        });
    }
    ...
    public void addInteropConfig(Config config) {
        this.mCamera2CameraControl.addCaptureRequestOptions(CaptureRequestOptions.Builder.from(config).build()).addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$gE8nk4w79KWZ6sZVp6CcD1ybwoI
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void clearInteropConfig() {
        this.mCamera2CameraControl.clearCaptureRequestOptions().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$QfmgMNDIpBTiB46C5YqHGZ7ZeV8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private ListenableFuture<Void> waitForSessionUpdateId(final long j) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$MGGroJR1UFqqxBdR5bZov7bbVZ4
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$waitForSessionUpdateId$4$Camera2CameraControlImpl(j, completer);
            }
        });
    }

    public /* synthetic */ Object lambda$waitForSessionUpdateId$4$Camera2CameraControlImpl(final long j, final CallbackToFutureAdapter.Completer completer) throws Exception {
        addCaptureResultListener(new CaptureResultListener() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$7nMNzxy7cSMZVbTizHa7taDi0dc
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(final List<CaptureConfig> list, final int i, final int i2) {
        ...
        return FutureChain.from(this.mFlashModeChangeSessionUpdateFuture).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$LGwT7APgBskCsUz1IDeYUdaWMeg
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return this.f$0.lambda$submitStillCaptureRequests$5$Camera2CameraControlImpl(list, i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }

    public /* synthetic */ ListenableFuture lambda$submitStillCaptureRequests$5$Camera2CameraControlImpl(List list, int i, int i2, int i3, Void r5) throws Exception {
    ...
    public void updateSessionConfig() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$D7IkFjWtL17PRTmbBpJ_4pzF-EI
            @Override // java.lang.Runnable
            public final void run() {
    ...
    ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$4fx5jSPM3fqmq8f-sZXOylTs1fc
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$updateSessionConfigAsync$7$Camera2CameraControlImpl(completer);
            }
        }));
    }

    public /* synthetic */ Object lambda$updateSessionConfigAsync$7$Camera2CameraControlImpl(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$-Hl2e4UjTzoodhB2QunEQz9mcWo
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$updateSessionConfigAsync$6$Camera2CameraControlImpl(completer);
            }
        });
        return "updateSessionConfigAsync";
    }

    public /* synthetic */ void lambda$updateSessionConfigAsync$6$Camera2CameraControlImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    void addSessionCameraCaptureCallback(final Executor executor, final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$ENbAOGLu-ybg0ZUJaTBBk4ZAfT0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$addSessionCameraCaptureCallback$8$Camera2CameraControlImpl(executor, cameraCaptureCallback);
            }
        });
    }

    public /* synthetic */ void lambda$addSessionCameraCaptureCallback$8$Camera2CameraControlImpl(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    void removeSessionCameraCaptureCallback(final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$3bkIsmbPe1n_z53YzjZogAYTfaU
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$removeSessionCameraCaptureCallback$9$Camera2CameraControlImpl(cameraCaptureCallback);
            }
        });
    }

    public /* synthetic */ void lambda$removeSessionCameraCaptureCallback$9$Camera2CameraControlImpl(CameraCaptureCallback cameraCaptureCallback) {
    ...
    */
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, final TotalCaptureResult totalCaptureResult) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$CameraControlSessionCallback$CvqA0Mwu3XCwbtARDhMAve6JDW0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCaptureCompleted$0$Camera2CameraControlImpl$CameraControlSessionCallback(totalCaptureResult);
                }
            });
        }
    ...
    static final class CameraCaptureCallbackSet extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(final CameraCaptureResult cameraCaptureResult) {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    this.mCallbackExecutors.get(cameraCaptureCallback).execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$CameraCaptureCallbackSet$VKo9HFS6pmWEGxCm_vI7qa8PAO8
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public void onCaptureFailed(final CameraCaptureFailure cameraCaptureFailure) {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    this.mCallbackExecutors.get(cameraCaptureCallback).execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$CameraCaptureCallbackSet$dMcw4eZray2IGXLI4YYERx5NrlE
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public void onCaptureCancelled() {
            for (final CameraCaptureCallback cameraCaptureCallback : this.mCallbacks) {
                try {
                    this.mCallbackExecutors.get(cameraCaptureCallback).execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$Camera2CameraControlImpl$CameraCaptureCallbackSet$ZD5rQdZmN1UyALhc5l6Zl9zdzPM
                        @Override // java.lang.Runnable
                        public final void run() {
