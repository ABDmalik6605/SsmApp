...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    public ListenableFuture<Void> open(final SessionConfig sessionConfig, final CameraDevice cameraDevice, final SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener) {
        ...
        return FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(surfaces, false, TIMEOUT_GET_SURFACE_IN_MS, this.mExecutor, this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$1HH2cwbglQNHVklEbzFOtp-bFFI
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return this.f$0.lambda$open$2$ProcessingCaptureSession(sessionConfig, cameraDevice, synchronizedCaptureSessionOpener, (List) obj);
            }
        }, this.mExecutor).transform(new Function() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$yDq4IAyo6njKSQM1TzfIqjZOXa0
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f$0.lambda$open$3$ProcessingCaptureSession((Void) obj);
            }
        }, this.mExecutor);
    }

    public /* synthetic */ ListenableFuture lambda$open$2$ProcessingCaptureSession(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener, List list) throws Exception {
        ...
        try {
            ...
            sessionConfigInitSession.getSurfaces().get(0).getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$T3CA6gj2s38sFuR4qKUUMhOo1iY
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$open$0$ProcessingCaptureSession();
                }
            ...
            for (final DeferrableSurface deferrableSurface2 : this.mProcessorSessionConfig.getSurfaces()) {
                ...
                deferrableSurface2.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$_NsZtceiMlnpLRnS84mZlemRsuY
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$open$0$ProcessingCaptureSession() {
        DeferrableSurfaces.decrementAll(this.mOutputSurfaces);
    }

    public /* synthetic */ Void lambda$open$3$ProcessingCaptureSession(Void r1) {
    ...
    class AnonymousClass2 implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureFailed(int i) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$2$L7ZWFq9_So3cDuafmPWxrN6RJsg
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCaptureFailed$0$ProcessingCaptureSession$2(captureConfig);
                }
            });
        }

        public /* synthetic */ void lambda$onCaptureFailed$0$ProcessingCaptureSession$2(CaptureConfig captureConfig) {
        ...
        public void onCaptureSequenceCompleted(int i) {
            Executor executor = ProcessingCaptureSession.this.mExecutor;
            final CaptureConfig captureConfig = this.val$captureConfig;
            executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$2$Dv5CiQEJNvBBmtV-YCKIVChxZOc
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCaptureSequenceCompleted$1$ProcessingCaptureSession$2(captureConfig);
                }
            });
        }

        public /* synthetic */ void lambda$onCaptureSequenceCompleted$1$ProcessingCaptureSession$2(CaptureConfig captureConfig) {
            Iterator<CameraCaptureCallback> it = captureConfig.getCameraCaptureCallbacks().iterator();
            while (it.hasNext()) {
    ...
    static class SessionProcessorCaptureCallback implements SessionProcessor.CaptureCallback {
        ...
        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public void onCaptureFailed(int i) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$SessionProcessorCaptureCallback$3XL_0JdNKhMzAtUBIP9SzcXs5wk
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCaptureFailed$0$ProcessingCaptureSession$SessionProcessorCaptureCallback();
                }
            });
        }

        public /* synthetic */ void lambda$onCaptureFailed$0$ProcessingCaptureSession$SessionProcessorCaptureCallback() {
        ...
        @Override // androidx.camera.core.impl.SessionProcessor.CaptureCallback
        public void onCaptureSequenceCompleted(int i) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ProcessingCaptureSession$SessionProcessorCaptureCallback$EqKVhLDl_qsuhWUroJg6eRZFugM
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCaptureSequenceCompleted$1$ProcessingCaptureSession$SessionProcessorCaptureCallback();
                }
            });
        }

        public /* synthetic */ void lambda$onCaptureSequenceCompleted$1$ProcessingCaptureSession$SessionProcessorCaptureCallback() {
            Iterator<CameraCaptureCallback> it = this.mCameraCaptureCallbacks.iterator();
            while (it.hasNext()) {
