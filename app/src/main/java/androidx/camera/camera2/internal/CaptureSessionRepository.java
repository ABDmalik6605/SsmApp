...
class CaptureSessionRepository {
    ...
    class AnonymousClass1 extends CameraDevice.StateCallback {
        ...
        private void forceOnClosedCaptureSessions() {
            ...
            CaptureSessionRepository.this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$CaptureSessionRepository$1$q1pEnwJM8hjC7sbsXJ4Ng6E12Wg
