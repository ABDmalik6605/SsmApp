...
public class ExposureControl {
    ...
    ListenableFuture<Integer> setExposureCompensationIndex(final int i) {
        ...
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$ExposureControl$-c1z8I1tfjukFxX2KVtD3M6vlyE
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$setExposureCompensationIndex$2$ExposureControl(i, completer);
            }
        }));
    }

    public /* synthetic */ Object lambda$setExposureCompensationIndex$2$ExposureControl(final int i, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$ExposureControl$SaZFvSzaIZAkd39FcKgufTo-9nY
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setExposureCompensationIndex$1$ExposureControl(completer, i);
            }
        });
        return "setExposureCompensationIndex[" + i + "]";
    }

    public /* synthetic */ void lambda$setExposureCompensationIndex$1$ExposureControl(final CallbackToFutureAdapter.Completer completer, final int i) {
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
        ...
        Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.-$$Lambda$ExposureControl$ibTjKt7gQzcLi2gjPfVhTa8N_cE
