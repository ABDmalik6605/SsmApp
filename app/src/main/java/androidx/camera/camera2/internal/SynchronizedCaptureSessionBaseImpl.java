...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSessionOpener.OpenerImpl {
    ...
    public ListenableFuture<Void> openCaptureSession(CameraDevice cameraDevice, final SessionConfigurationCompat sessionConfigurationCompat, final List<DeferrableSurface> list) {
        synchronized (this.mLock) {
            ...
            ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.-$$Lambda$SynchronizedCaptureSessionBaseImpl$BWFS2tPVPN2Gh15_9_SKp7XNUB4
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.lambda$openCaptureSession$0$SynchronizedCaptureSessionBaseImpl(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                }
            });
    ...
    public ListenableFuture<List<Surface>> startWithDeferrableSurface(final List<DeferrableSurface> list, long j) {
        synchronized (this.mLock) {
            ...
            FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.-$$Lambda$SynchronizedCaptureSessionBaseImpl$ItZPDkHkYxsDJjjIGCuHautkVZM
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return this.f$0.lambda$startWithDeferrableSurface$1$SynchronizedCaptureSessionBaseImpl(list, (List) obj);
                }
            }, getExecutor());
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$SynchronizedCaptureSessionBaseImpl$Nwv99-ihLOPhWdy4HQpKnG_ZQzc
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$close$2$SynchronizedCaptureSessionBaseImpl();
            }
        });
    }
    ...
    public void onClosed(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        finishClose();
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$SynchronizedCaptureSessionBaseImpl$GskmjQ2vFnb-QQTyLYNvAW0f8Ic
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onClosed$3$SynchronizedCaptureSessionBaseImpl(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    void onSessionFinished(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.-$$Lambda$SynchronizedCaptureSessionBaseImpl$5WHs8_7rVi2KT8zDGN6l5nujmlI
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onSessionFinished$4$SynchronizedCaptureSessionBaseImpl(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
