...
final class ImageSaver implements Runnable {
    ...
    public void run() throws IOException {
        ...
        if (fileSaveImageToTempFile != null) {
            this.mSequentialIoExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageSaver$B3iHDvDM2UNgfd15W3q-MlcpXJc
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$run$0$ImageSaver(fileSaveImageToTempFile);
                }
            });
        }
    }
    ...
    */
    ...
    private void postSuccess(final Uri uri) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageSaver$29vxg6qyjKwPRXgWrIwgYVInWKE
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$postSuccess$1$ImageSaver(uri);
                }
            });
    ...
    private void postError(final SaveError saveError, final String str, final Throwable th) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageSaver$q5J8WAquxyekKA6et-sNzW3OiJM
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$postError$2$ImageSaver(saveError, str, th);
                }
            });
        } catch (RejectedExecutionException unused) {
