...
public final class ImageCapture extends UseCase {
    ...
    */
    ...
    public void lambda$takePicture$4$ImageCapture(final Executor executor, final OnImageCapturedCallback onImageCapturedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$bl9Wyn95klP4uXF4W-FgBdr2wjw
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$takePicture$4$ImageCapture(executor, onImageCapturedCallback);
                }
            });
        } else {
    ...
    /* renamed from: takePicture, reason: merged with bridge method [inline-methods] */
    public void lambda$takePicture$5$ImageCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnImageSavedCallback onImageSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$UKL-ekYrSoki_xLERA7IPgbsT_Y
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$takePicture$5$ImageCapture(outputFileOptions, executor, onImageSavedCallback);
                }
            });
            return;
        }
    ...
    private void sendImageCaptureRequest(Executor executor, final OnImageCapturedCallback onImageCapturedCallback, int i) {
        ...
        if (camera == null) {
            executor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$KD7dAXJInI6lgW7R231JNrWbu9Q
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$sendImageCaptureRequest$6$ImageCapture(onImageCapturedCallback);
                }
            });
            return;
        }
        ImageCaptureRequestProcessor imageCaptureRequestProcessor = this.mImageCaptureRequestProcessor;
        if (imageCaptureRequestProcessor == null) {
            executor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$2TyP4SJ-_IpsOVEDQVd20jTrO5M
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public ListenableFuture<ImageProxy> lambda$createPipeline$2$ImageCapture(final ImageCaptureRequest imageCaptureRequest) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$bbnz71YiDMP6bZjiWLFVvJ73O98
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$takePictureInternal$10$ImageCapture(imageCaptureRequest, completer);
            }
        });
    }
    ...
    public /* synthetic */ Object lambda$takePictureInternal$10$ImageCapture(ImageCaptureRequest imageCaptureRequest, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$akqdavXlJvc7E7FhqDkETzjk3sg
            @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
        ...
        completer.addCancellationListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$OpDA3xKMli8AiXtGyy9FdWPkNPk
            @Override // java.lang.Runnable
            public final void run() {
    ...
    ListenableFuture<Void> issueTakePicture(ImageCaptureRequest imageCaptureRequest) {
        ...
        return Futures.transform(getCameraControl().submitStillCaptureRequests(arrayList, this.mCaptureMode, this.mFlashType), new Function() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$b_HvTKJgKFQvOTuOV-1cgWwtRSo
    ...
    static class ImageCaptureRequest {
        ...
        void dispatchImage(ImageProxy imageProxy) {
            ...
            try {
                this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$ImageCaptureRequest$qoA5qq09pd6WiAozSV4_F8ZuXL4
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$dispatchImage$0$ImageCapture$ImageCaptureRequest(settableImageProxy);
                    }
                });
            ...
            if (this.mDispatched.compareAndSet(false, true)) {
                try {
                    this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageCapture$ImageCaptureRequest$KlqAxzwB-08wcOFrjThjf8ncF2g
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$notifyCallbackError$1$ImageCapture$ImageCaptureRequest(i, str, th);
                        }
                    });
                } catch (RejectedExecutionException unused) {
                    Logger.e(ImageCapture.TAG, "Unable to post to the supplied executor.");
