...
public class SurfaceSorter {
    ...
    public void sort(List<DeferrableSurface> list) {
        if (this.mHasQuirk) {
            Collections.sort(list, new Comparator() { // from class: androidx.camera.core.internal.compat.workaround.-$$Lambda$SurfaceSorter$0_82dK2SszmbATLXFlp9TInGWhI
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return this.f$0.lambda$sort$0$SurfaceSorter((DeferrableSurface) obj, (DeferrableSurface) obj2);
                }
            });
        }
    }

    public /* synthetic */ int lambda$sort$0$SurfaceSorter(DeferrableSurface deferrableSurface, DeferrableSurface deferrableSurface2) {
