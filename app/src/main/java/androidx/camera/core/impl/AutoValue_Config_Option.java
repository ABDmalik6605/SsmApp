...
final class AutoValue_Config_Option<T> extends Config.Option<T> {
    ...
    public String toString() {
        return "Option{id=" + this.f3id + ", valueClass=" + this.valueClass + ", token=" + this.token + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f3id.equals(option.getId()) && this.valueClass.equals(option.getValueClass())) {
    ...
    public int hashCode() {
        int iHashCode = (((this.f3id.hashCode() ^ 1000003) * 1000003) ^ this.valueClass.hashCode()) * 1000003;
