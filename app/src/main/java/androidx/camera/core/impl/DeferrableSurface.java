...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.-$$Lambda$DeferrableSurface$wMRiPdD1C1tbUKlVUl-Mz7xlLek
        ...
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.-$$Lambda$DeferrableSurface$13QMUOcQGzlxlv9vqLR0sMkygxw
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$1$DeferrableSurface(stackTraceString);
                }
