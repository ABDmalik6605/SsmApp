...
public final class DeferrableSurfaces {
    ...
    public static ListenableFuture<List<Surface>> surfaceListWithTimeout(Collection<DeferrableSurface> collection, final boolean z, final long j, final Executor executor, final ScheduledExecutorService scheduledExecutorService) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.-$$Lambda$DeferrableSurfaces$abjQsppj5FhX2izw95jhr6uUzww
    ...
    static /* synthetic */ Object lambda$surfaceListWithTimeout$3(List list, ScheduledExecutorService scheduledExecutorService, final Executor executor, final long j, final boolean z, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        final ScheduledFuture<?> scheduledFutureSchedule = scheduledExecutorService.schedule(new Runnable() { // from class: androidx.camera.core.impl.-$$Lambda$DeferrableSurfaces$lbJtfPV2FFmAsFEbMbMDgxEA5Ws
        ...
        completer.addCancellationListener(new Runnable() { // from class: androidx.camera.core.impl.-$$Lambda$DeferrableSurfaces$EGqAWGETFT7PhtXUvUxtyOw5gdQ
            @Override // java.lang.Runnable
            public final void run() {
