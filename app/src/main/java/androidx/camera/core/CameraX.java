...
public final class CameraX {
    ...
    private ListenableFuture<Void> initInternal(final Context context) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.-$$Lambda$CameraX$TA_Qqr_qqcrvk98oeC1Ye3pw2tQ
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.lambda$initInternal$0$CameraX(context, completer);
                }
            });
        }
        return future;
    ...
    public /* synthetic */ Object lambda$initInternal$0$CameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$CameraX$dnuYhxGsACX_lH-9SVlUVTdtTJg
            @Override // java.lang.Runnable
            public final void run() throws InitializationException {
                this.f$0.lambda$initAndRetryRecursively$2$CameraX(context, executor, completer, j);
            }
        });
    }

    public /* synthetic */ void lambda$initAndRetryRecursively$2$CameraX(Context context, final Executor executor, final CallbackToFutureAdapter.Completer completer, final long j) throws InitializationException {
        try {
            ...
            if (SystemClock.elapsedRealtime() - j < 2500) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.-$$Lambda$CameraX$rBIbGOUXygU0MV7yApaebqAdkqM
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$initAndRetryRecursively$1$CameraX(executor, j, completer);
                    }
    ...
    public /* synthetic */ void lambda$initAndRetryRecursively$1$CameraX(Executor executor, long j, CallbackToFutureAdapter.Completer completer) {
    ...
    private ListenableFuture<Void> shutdownInternal() {
        synchronized (this.mInitializeLock) {
            ...
            if (i == 3 || i == 4) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.-$$Lambda$CameraX$8Js4Msrb33mYBAMf1whJOlmPquE
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return this.f$0.lambda$shutdownInternal$4$CameraX(completer);
                    }
                });
            }
    ...
    public /* synthetic */ Object lambda$shutdownInternal$4$CameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$CameraX$mv8MIrewNXG8R_SEUl1Vxae_cWw
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$shutdownInternal$3$CameraX(completer);
            }
        }, this.mCameraExecutor);
        return "CameraX shutdownInternal";
    }

    public /* synthetic */ void lambda$shutdownInternal$3$CameraX(CallbackToFutureAdapter.Completer completer) {
