...
public final class VideoCapture extends UseCase {
    ...
    public void lambda$startRecording$0$VideoCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$Acd00xL7-Y3_1vluLXR5ElTveSg
                @Override // java.lang.Runnable
                public final void run() throws IllegalStateException {
                    this.f$0.lambda$startRecording$0$VideoCapture(outputFileOptions, executor, onVideoSavedCallback);
                }
            });
            return;
        }
        ...
        this.mRecordingFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$ktB5yi8vAADstEBX7AUjsqkXb9A
        ...
        this.mRecordingFuture.addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$cW7mtBhaRZGAtN35UBK5j0WmO-k
            @Override // java.lang.Runnable
        ...
        try {
            ...
            try {
                ...
                notifyUpdated();
                if (this.mIsAudioEnabled.get()) {
                    this.mAudioHandler.post(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$PooxYm54a8KXAeyxocKERgm5l5Q
                        @Override // java.lang.Runnable
                        public final void run() throws IllegalStateException, MediaCodec.CryptoException {
                            this.f$0.lambda$startRecording$3$VideoCapture(videoSavedListenerWrapper);
                        }
                    });
                }
                final String cameraId = getCameraId();
                final Size attachedSurfaceResolution = getAttachedSurfaceResolution();
                this.mVideoHandler.post(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$ggPRD8ZYg13Lr_StexqXK45KgPA
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$startRecording$4$VideoCapture(videoSavedListenerWrapper, cameraId, attachedSurfaceResolution, outputFileOptions, completer);
                    }
                });
    ...
    public /* synthetic */ void lambda$startRecording$4$VideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void lambda$stopRecording$5$VideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$nGm6ixcqIwXQ9Uz6sLgyMXPK2aE
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$stopRecording$5$VideoCapture();
                }
            });
            return;
        }
    ...
    public void onDetached() {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$pFXPMCy4Z1n_8LWnkUvVoDWdli0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onDetached$6$VideoCapture();
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
    ...
    private void releaseCameraSurface(final boolean z) {
        ...
        this.mDeferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$_JVErJ9i9kCqYUUGWiW0YPTzhvI
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean lambda$startRecording$3$VideoCapture(OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException, MediaCodec.CryptoException {
        long j = 0;
    ...
    */
    ...
    static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public void onVideoSaved(final OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$VideoSavedListenerWrapper$ezuRAsUWou927AqB2d_IAm1qICY
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onVideoSaved$0$VideoCapture$VideoSavedListenerWrapper(outputFileResults);
                    }
                });
        ...
        public void onError(final int i, final String str, final Throwable th) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$VideoCapture$VideoSavedListenerWrapper$1SGQcwV6lI92nyvZkZvFz3For8Y
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onError$1$VideoCapture$VideoSavedListenerWrapper(i, str, th);
                    }
                });
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
