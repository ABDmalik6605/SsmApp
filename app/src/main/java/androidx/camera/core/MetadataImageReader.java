...
class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    MetadataImageReader(ImageReaderProxy imageReaderProxy) {
        ...
        this.mTransformedListener = new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.-$$Lambda$MetadataImageReader$5BCjqfsC6khPZYU3ar10sNremNk
            @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy2) {
                this.f$0.lambda$new$0$MetadataImageReader(imageReaderProxy2);
            }
        };
        this.mClosed = false;
            ...
            if (executor != null) {
                executor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$MetadataImageReader$C7g90z7hwLV6QN-8XBXSjZSrz20
                    ...
                    public final void run() {
                        this.f$0.lambda$enqueueImageProxy$1$MetadataImageReader(onImageAvailableListener);
                    }
                });
            } else {
    ...
    public void lambda$new$0$MetadataImageReader(ImageReaderProxy imageReaderProxy) {
        synchronized (this.mLock) {
            if (this.mClosed) {
                return;
            }
