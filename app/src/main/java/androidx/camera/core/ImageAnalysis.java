...
public final class ImageAnalysis extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageAnalysisConfig imageAnalysisConfig, final Size size) {
        ...
        immediateSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$ImageAnalysis$qYfLQgKUsjs4t0wwgvwG8_sJ0ZY
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.-$$Lambda$ImageAnalysis$oTj_uUjtBmoxiUQD_sDJ5PfYTz8
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.lambda$createPipeline$1$ImageAnalysis(str, imageAnalysisConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    public /* synthetic */ void lambda$createPipeline$1$ImageAnalysis(String str, ImageAnalysisConfig imageAnalysisConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
    ...
    public void setAnalyzer(Executor executor, final Analyzer analyzer) {
        synchronized (this.mAnalysisLock) {
            this.mImageAnalysisAbstractAnalyzer.setAnalyzer(executor, new Analyzer() { // from class: androidx.camera.core.-$$Lambda$ImageAnalysis$nIAz9HE3CRS1_vFJkazzoVeZNbw
