...
class CameraExecutor implements Executor {
    ...
    private static ThreadPoolExecutor createExecutor() {
        ...
        threadPoolExecutor.setRejectedExecutionHandler(new RejectedExecutionHandler() { // from class: androidx.camera.core.-$$Lambda$CameraExecutor$lHYezgWE73XtH9wI9012Jbiyz1o
