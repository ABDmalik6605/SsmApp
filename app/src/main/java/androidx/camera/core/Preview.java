...
public final class Preview extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final PreviewConfig previewConfig, final Size size) {
        ...
        if (captureProcessor != null) {
            ...
            processingSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.-$$Lambda$9fivo9ldn_tYa06As_pqQ23Mr10
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.-$$Lambda$Preview$WtQW2Zy9cGuDwxes3k4z9U6d1nc
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.lambda$createPipeline$0$Preview(str, previewConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    private boolean sendSurfaceRequestIfReady() {
        ...
        this.mSurfaceProviderExecutor.execute(new Runnable() { // from class: androidx.camera.core.-$$Lambda$Preview$cQQSNpTD_vzDR540rq5dmfARJz4
            @Override // java.lang.Runnable
            public final void run() {
