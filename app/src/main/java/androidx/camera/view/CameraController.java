...
public abstract class CameraController {
    ...
    CameraController(Context context) {
        ...
        this.mInitializationFuture = Futures.transform(ProcessCameraProvider.getInstance(applicationContext), new Function() { // from class: androidx.camera.view.-$$Lambda$CameraController$QqOSg773jIcrH1sf43S7nXXv__E
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f$0.lambda$new$0$CameraController((ProcessCameraProvider) obj);
            }
        ...
        this.mDeviceRotationListener = new RotationProvider.Listener() { // from class: androidx.camera.view.-$$Lambda$CameraController$4KytXc-Oh5aXzRsUw2MY0JJNn9k
            @Override // androidx.camera.view.RotationProvider.Listener
            public final void onRotationChanged(int i) {
                this.f$0.lambda$new$1$CameraController(i);
            }
        };
    }
    ...
    public /* synthetic */ void lambda$new$1$CameraController(int i) {
    ...
    public void setEnabledUseCases(int i) {
        ...
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.-$$Lambda$CameraController$Z6g6lget0LqGkr_FXdA5-GLDxaU
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setEnabledUseCases$2$CameraController(i2);
            }
        });
    }

    public /* synthetic */ void lambda$setEnabledUseCases$2$CameraController(int i) {
        this.mEnabledUseCases = i;
    }
    ...
    public void startRecording(OutputFileOptions outputFileOptions, Executor executor, final OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException {
        ...
        this.mVideoCapture.lambda$startRecording$0$VideoCapture(outputFileOptions.toVideoCaptureOutputFileOptions(), executor, new VideoCapture.OnVideoSavedCallback() { // from class: androidx.camera.view.CameraController.1
    ...
    public void setCameraSelector(CameraSelector cameraSelector) {
        ...
        processCameraProvider.unbind(this.mPreview, this.mImageCapture, this.mImageAnalysis, this.mVideoCapture);
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.-$$Lambda$CameraController$dM5nTyOJqHPwlDwd4DDGqw0bQfM
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$setCameraSelector$3$CameraController(cameraSelector2);
            }
        });
    }

    public /* synthetic */ void lambda$setCameraSelector$3$CameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
