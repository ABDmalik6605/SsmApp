...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    private void startPreviewStreamStateFlow(final CameraInfo cameraInfo) {
        ...
        FutureChain futureChainTransform = FutureChain.from(waitForCaptureResult(cameraInfo, arrayList)).transformAsync(new AsyncFunction() { // from class: androidx.camera.view.-$$Lambda$PreviewStreamStateObserver$yGnlIC7TVJCR4bONLgg3hhjXkrc
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return this.f$0.lambda$startPreviewStreamStateFlow$0$PreviewStreamStateObserver((Void) obj);
            }
        }, CameraXExecutors.directExecutor()).transform(new Function() { // from class: androidx.camera.view.-$$Lambda$PreviewStreamStateObserver$_cwgtHjD7ilu2LvWhgMiFgcn29E
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f$0.lambda$startPreviewStreamStateFlow$1$PreviewStreamStateObserver((Void) obj);
            }
    ...
    public /* synthetic */ ListenableFuture lambda$startPreviewStreamStateFlow$0$PreviewStreamStateObserver(Void r1) throws Exception {
        return this.mPreviewViewImplementation.waitForNextFrame();
    }

    public /* synthetic */ Void lambda$startPreviewStreamStateFlow$1$PreviewStreamStateObserver(Void r1) {
    ...
    private ListenableFuture<Void> waitForCaptureResult(final CameraInfo cameraInfo, final List<CameraCaptureCallback> list) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.-$$Lambda$PreviewStreamStateObserver$s3Kpm2RVxghf9T55KLG5pm4TGi4
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.lambda$waitForCaptureResult$2$PreviewStreamStateObserver(cameraInfo, list, completer);
            }
        });
    }
