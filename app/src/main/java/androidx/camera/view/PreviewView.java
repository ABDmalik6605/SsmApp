...
public final class PreviewView extends FrameLayout {
    ...
    class AnonymousClass1 implements Preview.SurfaceProvider {
        ...
        public void onSurfaceRequested(final SurfaceRequest surfaceRequest) {
            ...
            if (!Threads.isMainThread()) {
                ContextCompat.getMainExecutor(PreviewView.this.getContext()).execute(new Runnable() { // from class: androidx.camera.view.-$$Lambda$PreviewView$1$g3lRYHwwAGJlXtgKG6mjFWZkEis
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onSurfaceRequested$0$PreviewView$1(surfaceRequest);
                    }
                });
                return;
            }
            ...
            surfaceRequest.setTransformationInfoListener(ContextCompat.getMainExecutor(PreviewView.this.getContext()), new SurfaceRequest.TransformationInfoListener() { // from class: androidx.camera.view.-$$Lambda$PreviewView$1$FoS72QlvxkQsBmSXKEMS4a3z768
                @Override // androidx.camera.core.SurfaceRequest.TransformationInfoListener
                public final void onTransformationInfoUpdate(SurfaceRequest.TransformationInfo transformationInfo) {
                    this.f$0.lambda$onSurfaceRequested$1$PreviewView$1(camera, surfaceRequest, transformationInfo);
                }
            });
            ...
            PreviewView.this.mImplementation.onSurfaceRequested(surfaceRequest, new PreviewViewImplementation.OnSurfaceNotInUseListener() { // from class: androidx.camera.view.-$$Lambda$PreviewView$1$8fsl-H5n3M3NX_CjCSjom_z63eo
                @Override // androidx.camera.view.PreviewViewImplementation.OnSurfaceNotInUseListener
                public final void onSurfaceNotInUse() {
                    this.f$0.lambda$onSurfaceRequested$2$PreviewView$1(previewStreamStateObserver, camera);
                }
            });
        }
    ...
    public PreviewView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mOnLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: androidx.camera.view.-$$Lambda$PreviewView$wXnp5OZxmlro6UhkYqYkud6koME
            @Override // android.view.View.OnLayoutChangeListener
            public final void onLayoutChange(View view, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10) {
                this.f$0.lambda$new$0$PreviewView(view, i3, i4, i5, i6, i7, i8, i9, i10);
            }
        };
