...
public class Secondary_Type extends BaseFragment implements View.OnClickListener {
    Button btn_back;
    CardView cv_arts;
    CardView cv_bio;
    ...
    public Secondary_Type(String s) {
        this.title = "";
        this.title = s;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View viewInflate = inflater.inflate(R.layout.frag_enrollment_secondary_type, (ViewGroup) null);
        ...
        CardView cardView3 = (CardView) this.mView.findViewById(R.id.cv_bio);
        this.cv_bio = cardView3;
        cardView3.setOnClickListener(this);
        CardView cardView4 = (CardView) this.mView.findViewById(R.id.cv_commerce);
        this.cv_commerce = cardView4;
        cardView4.setOnClickListener(this);
        CardView cardView5 = (CardView) this.mView.findViewById(R.id.cv_other);
        this.cv_other = cardView5;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.btn_back.setOnClickListener(new View.OnClickListener() { // from class: com.micromerger.ssms.startmonitoring.fragments.enrollment.Secondary_Type.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Secondary_Type.this.fm.popBackStack();
            }
        });
    }
    ...
    public void onResume() {
        ...
        while (it.hasNext()) {
            ...
            if (value.getKRAName().contains(Constant.Is_Completed_)) {
                ...
                if (value.getKRAName().equals(Constant.Is_Completed_ + this.title + Constant._Science_Biology) && Boolean.parseBoolean(String.valueOf(value.getDataValue()))) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.cv_arts /* 2131230955 */:
                ...
                break;
            case R.id.cv_bio /* 2131230956 */:
                changeFragment(new EnrollmentDetail(this.title, Constant._Science_Biology));
                break;
