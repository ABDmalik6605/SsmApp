...
public final class IbScanPortBinding implements ViewBinding {
    ...
    public static IbScanPortBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static IbScanPortBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.ib_scan_port, parent, false);
        if (attachToParent) {
    ...
    public static IbScanPortBinding bind(View rootView) {
                    ...
                    if (button != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                ...
                                if (textView4 != null) {
                                    i = R.id.empty_btn;
                                    Button button2 = (Button) rootView.findViewById(R.id.empty_btn);
                                    if (button2 != null) {
                                        i = R.id.frame_time;
                                                                    ...
                                                                    if (textView8 != null) {
                                                                        ...
                                                                        if (textView9 != null) {
                                                                            ...
                                                                            if (textView10 != null) {
                                                                                ...
                                                                                Button button5 = (Button) rootView.findViewById(R.id.start_capture_btn);
                                                                                if (button5 != null) {
                                                                                    i = R.id.status;
                                                                                    ...
                                                                                    if (textView11 != null) {
                                                                                        ...
                                                                                        if (textView12 != null) {
                                                                                            ...
                                                                                            Button button6 = (Button) rootView.findViewById(R.id.stop_capture_btn);
                                                                                            if (button6 != null) {
                                                                                                i = R.id.title;
                                                                                                ...
                                                                                                if (textView13 != null) {
                                                                                                    ...
                                                                                                    if (textView14 != null) {
                                                                                                        ...
                                                                                                        Button button7 = (Button) rootView.findViewById(R.id.view_database_btn);
                                                                                                        if (button7 != null) {
                                                                                                            return new IbScanPortBinding(linearLayout, textView, spinner, spinner2, button, textView2, textView3, textView4, button2, textView5, textView6, linearLayout, imageView, button3, imageView2, button4, textView7, textView8, textView9, textView10, button5, textView11, textView12, button6, textView13, textView14, button7);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
