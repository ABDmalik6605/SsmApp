...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attributeSet) throws Resources.NotFoundException, NoSuchMethodException, SecurityException {
        ...
        try {
            this.backgroundColor = typedArrayObtainStyledAttributes.getColor(R.styleable.MaterialSpinner_ms_background_color, -1);
            this.backgroundSelector = typedArrayObtainStyledAttributes.getResourceId(R.styleable.MaterialSpinner_ms_background_selector, 0);
            this.textColor = typedArrayObtainStyledAttributes.getColor(R.styleable.MaterialSpinner_ms_text_color, defaultColor);
            this.hintColor = typedArrayObtainStyledAttributes.getColor(R.styleable.MaterialSpinner_ms_hint_color, defaultColor);
            this.arrowColor = typedArrayObtainStyledAttributes.getColor(R.styleable.MaterialSpinner_ms_arrow_tint, this.textColor);
            this.hideArrow = typedArrayObtainStyledAttributes.getBoolean(R.styleable.MaterialSpinner_ms_hide_arrow, false);
            this.hintText = typedArrayObtainStyledAttributes.getString(R.styleable.MaterialSpinner_ms_hint) == null ? "" : typedArrayObtainStyledAttributes.getString(R.styleable.MaterialSpinner_ms_hint);
            this.popupWindowMaxHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_dropdown_max_height, 0);
            this.popupWindowHeight = typedArrayObtainStyledAttributes.getLayoutDimension(R.styleable.MaterialSpinner_ms_dropdown_height, -2);
            ...
            this.popupPaddingTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_top, dimensionPixelSize5);
            this.popupPaddingLeft = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_left, dimensionPixelSize4);
            this.popupPaddingBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_bottom, dimensionPixelSize5);
            this.popupPaddingRight = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_right, dimensionPixelSize4);
            ...
            if (!this.hideArrow) {
                Drawable drawableMutate = Utils.getDrawable(context, R.drawable.ms__arrow).mutate();
                this.arrowDrawable = drawableMutate;
                drawableMutate.setColorFilter(this.arrowColor, PorterDuff.Mode.SRC_IN);
    ...
    public <T> void setItems(List<T> list) {
        MaterialSpinnerBaseAdapter<T> textColor = new MaterialSpinnerAdapter(getContext(), list).setPopupPadding(this.popupPaddingLeft, this.popupPaddingTop, this.popupPaddingRight, this.popupPaddingBottom).setBackgroundSelector(this.backgroundSelector).setTextColor(this.textColor);
        this.adapter = textColor;
        setAdapterInternal(textColor);
    }

    public void setAdapter(ListAdapter listAdapter) {
        MaterialSpinnerBaseAdapter textColor = new MaterialSpinnerAdapterWrapper(getContext(), listAdapter).setPopupPadding(this.popupPaddingLeft, this.popupPaddingTop, this.popupPaddingRight, this.popupPaddingBottom).setBackgroundSelector(this.backgroundSelector).setTextColor(this.textColor);
        this.adapter = textColor;
        setAdapterInternal(textColor);
    }
