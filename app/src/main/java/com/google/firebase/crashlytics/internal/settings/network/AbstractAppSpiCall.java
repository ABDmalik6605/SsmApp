...
abstract class AbstractAppSpiCall extends AbstractSpiCall implements AppSpiCall {
    ...
    public boolean invoke(AppRequestData appRequestData, boolean z) {
        ...
        try {
            ...
            String str = "POST".equalsIgnoreCase(httpRequestApplyMultipartDataTo.method()) ? "Create" : "Update";
            Logger.getLogger().d(str + " app request ID: " + httpResponseExecute.header(AbstractSpiCall.HEADER_REQUEST_ID));
