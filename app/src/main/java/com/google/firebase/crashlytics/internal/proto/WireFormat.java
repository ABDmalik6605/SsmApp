...
final class WireFormat {
    ...
    static class FieldType {
        ...
        static {
            ...
            GROUP = fieldType10;
            FieldType fieldType11 = new FieldType(Constant.MESSAGE, 10, JavaType.MESSAGE, i) { // from class: com.google.firebase.crashlytics.internal.proto.WireFormat.FieldType.3
                @Override // com.google.firebase.crashlytics.internal.proto.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
