...
public final class zzmh implements zzme {
    ...
    static {
        ...
        zzb = zzdmVar.zza("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        ...
        zzk = zzdmVar.zza("measurement.alarm_manager.minimum_interval", DateUtils.MILLIS_PER_MINUTE);
        zzl = zzdmVar.zza("measurement.upload.minimum_delay", 500L);
        zzm = zzdmVar.zza("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        ...
        zzp = zzdmVar.zza("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzs = zzdmVar.zza("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzv = zzdmVar.zza("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzaj = zzdmVar.zza("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
    }
}
