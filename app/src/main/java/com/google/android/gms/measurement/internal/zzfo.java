    ...
    private final void zza(String str, zzca.zzb.zza zzaVar) throws IllegalStateException {
        ...
        if (zzaVar != null) {
            for (int i = 0; i < zzaVar.zza(); i++) {
                zzca.zza.C0013zza c0013zzaZzbo = zzaVar.zza(i).zzbo();
                if (TextUtils.isEmpty(c0013zzaZzbo.zza())) {
                    zzq().zzh().zza("EventConfig contained null event name");
                } else {
                    String strZza = c0013zzaZzbo.zza();
                    String strZzb = zzgv.zzb(c0013zzaZzbo.zza());
                    if (!TextUtils.isEmpty(strZzb)) {
                        c0013zzaZzbo = c0013zzaZzbo.zza(strZzb);
                        zzaVar.zza(i, c0013zzaZzbo);
                    }
                    if (zzlo.zzb() && zzs().zza(zzas.zzcm)) {
                        arrayMap.put(strZza, Boolean.valueOf(c0013zzaZzbo.zzb()));
                    } else {
                        arrayMap.put(c0013zzaZzbo.zza(), Boolean.valueOf(c0013zzaZzbo.zzb()));
                    }
                    arrayMap2.put(c0013zzaZzbo.zza(), Boolean.valueOf(c0013zzaZzbo.zzc()));
                    if (c0013zzaZzbo.zzd()) {
                        if (c0013zzaZzbo.zze() < zzc || c0013zzaZzbo.zze() > zzb) {
                            zzq().zzh().zza("Invalid sampling rate. Event name, sample rate", c0013zzaZzbo.zza(), Integer.valueOf(c0013zzaZzbo.zze()));
                        } else {
                            arrayMap3.put(c0013zzaZzbo.zza(), Integer.valueOf(c0013zzaZzbo.zze()));
                        }
                    }
                }
            }
