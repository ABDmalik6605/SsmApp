    ...
    public final byte[] zza(zzaq zzaqVar, String str) throws IllegalStateException {
        ...
        try {
            ...
            if (next == null || next.zze == null) {
                zzkw zzkwVar = new zzkw(strZzc, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzl().currentTimeMillis(), 0L);
                listZza.add(zzkwVar);
                zzi().zza(zzkwVar);
            }
            zzkr zzkrVarF_ = f_();
            ...
            if (zzkrVarF_.zzk().zzi()) {
                ...
                if (zzfVarZzb.zzaf() && zzkrVarF_.zzj().zze(strZzc2)) {
                    ...
                    listZza.add(new zzkw(strZzc2, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_npa", zzkrVarF_.zzl().currentTimeMillis(), 1L));
                }
            }
            ...
            zzfVar.zzv();
            zzcd.zzg.zza zzaVarZza4 = zzaVar3.zzg((int) zzfVar.zzs()).zzg(33025L).zza(zzl().currentTimeMillis());
