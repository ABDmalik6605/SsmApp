    ...
    */
    ...
    private final int zza(T t, byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, long j, int i7, long j2, zzgo zzgoVar) throws IOException {
        ...
        switch (i7) {
            ...
            case 26:
                if (i5 == 2) {
                    if ((j & IBScanDevice.IBSU_LED_F_BLINK_RED) == 0) {
                        iZza2 = zzgl.zza(bArr, iZza2, zzgoVar);
                        int i18 = zzgoVar.zza;
                        if (i18 < 0) {
                            throw zzij.zzb();
                        }
                        if (i18 == 0) {
                            ...
                            zzigVarZza.add(new String(bArr, iZza2, i18, zzia.zza));
                            iZza2 += i18;
                        }
                        while (iZza2 < i2) {
                            int iZza10 = zzgl.zza(bArr, iZza2, zzgoVar);
                            if (i3 == zzgoVar.zza) {
                                iZza2 = zzgl.zza(bArr, iZza10, zzgoVar);
                                int i19 = zzgoVar.zza;
                                if (i19 < 0) {
                                    throw zzij.zzb();
                                }
                                if (i19 == 0) {
                                    ...
                                    zzigVarZza.add(new String(bArr, iZza2, i19, zzia.zza));
                                    iZza2 += i19;
                                }
                            }
                        }
                        ...
                        if (i20 == 0) {
                            ...
                            int i21 = iZza2 + i20;
                            if (!zzlb.zza(bArr, iZza2, i21)) {
                                throw zzij.zzh();
                            }
                            zzigVarZza.add(new String(bArr, iZza2, i20, zzia.zza));
                            iZza2 = i21;
                        }
                        while (iZza2 < i2) {
                            int iZza11 = zzgl.zza(bArr, iZza2, zzgoVar);
                            if (i3 == zzgoVar.zza) {
                                iZza2 = zzgl.zza(bArr, iZza11, zzgoVar);
                                int i22 = zzgoVar.zza;
                                if (i22 < 0) {
                                    throw zzij.zzb();
                                }
                                if (i22 == 0) {
                                    ...
                                    int i23 = iZza2 + i22;
                                    if (!zzlb.zza(bArr, iZza2, i23)) {
                                        throw zzij.zzh();
                                    }
                                    zzigVarZza.add(new String(bArr, iZza2, i22, zzia.zza));
                                    iZza2 = i23;
                                }
                            }
                        }
            ...
            case 28:
                if (i5 == 2) {
                    ...
                    if (i24 == 0) {
                        ...
                        zzigVarZza.add(zzgp.zza(bArr, iZza12, i24));
                        iZza12 += i24;
                    }
                    while (iZza12 < i2) {
                        ...
                        if (i25 == 0) {
                            ...
                            zzigVarZza.add(zzgp.zza(bArr, iZza12, i25));
                            iZza12 += i25;
                        }
                    }
                    return iZza12;
            ...
            case 47:
                if (i5 == 2) {
                    ...
                    int i26 = zzgoVar.zza + iZza14;
                    while (iZza14 < i26) {
                        iZza14 = zzgl.zza(bArr, iZza14, zzgoVar);
                ...
                if (i5 == 0) {
                    ...
                    int iZza15 = zzgl.zza(bArr, iZza2, zzgoVar);
                    zzibVar4.zzd(zzhb.zze(zzgoVar.zza));
                    while (iZza15 < i2) {
                        int iZza16 = zzgl.zza(bArr, iZza15, zzgoVar);
                        if (i3 != zzgoVar.zza) {
                            return iZza15;
                        }
                        iZza15 = zzgl.zza(bArr, iZza16, zzgoVar);
                        zzibVar4.zzd(zzhb.zze(zzgoVar.zza));
                    }
                    return iZza15;
                }
            ...
            case 48:
                if (i5 == 2) {
                    ...
                    int i27 = zzgoVar.zza + iZza17;
                    while (iZza17 < i27) {
                        iZza17 = zzgl.zzb(bArr, iZza17, zzgoVar);
                ...
                if (i5 == 0) {
                    ...
                    while (iZzb2 < i2) {
                        int iZza18 = zzgl.zza(bArr, iZzb2, zzgoVar);
                        if (i3 != zzgoVar.zza) {
                            return iZzb2;
                        }
                        iZzb2 = zzgl.zzb(bArr, iZza18, zzgoVar);
                        zzixVar6.zza(zzhb.zza(zzgoVar.zzb));
                    }
                    return iZzb2;
                }
            ...
            case 49:
                if (i5 == 3) {
                    ...
                    while (iZza2 < i2) {
                        ...
                        if (i3 == zzgoVar.zza) {
                            iZza2 = zzgl.zza(zzkbVarZza, bArr, iZza19, i2, i28, zzgoVar);
                            zzigVarZza.add(zzgoVar.zzc);
                        }
                    }
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:155:0x04e4, code lost:
        ...
        if (r2 >= r9.zzn) goto L240;
     */
    /* JADX WARN: Code restructure failed: missing block: B:156:0x04e6, code lost:
    
        r1 = (com.google.android.gms.internal.measurement.zzks) r9.zza(r12, r9.zzl[r2], (int) r1, (com.google.android.gms.internal.measurement.zzkt<UT, int>) r9.zzq);
        r2 = r2 + 1;
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    final int zza(T r28, byte[] r29, int r30, int r31, int r32, com.google.android.gms.internal.measurement.zzgo r33) throws java.io.IOException {
        /*
