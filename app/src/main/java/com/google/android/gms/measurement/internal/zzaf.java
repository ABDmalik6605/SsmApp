...
final class zzaf extends zzki {
    ...
    */
    ...
    public final long zzc(String str) throws IllegalStateException {
        ...
        zzaj();
        try {
            return c_().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(DurationKt.NANOS_IN_MILLIS, zzs().zzb(str, zzas.zzo))))});
        } catch (SQLiteException e) {
    ...
    */
    ...
    public final boolean zza(zzcd.zzg zzgVar, boolean z) throws IllegalStateException {
        ...
        try {
            ...
            contentValues.put(Constants.ScionAnalytics.MessageType.DATA_MESSAGE, bArrZzc);
    ...
    */
    ...
    public final List<Pair<zzcd.zzg, Long>> zza(String str, int i, int i2) {
        ...
        try {
            try {
                Cursor cursorQuery = c_().query("queue", new String[]{"rowid", Constants.ScionAnalytics.MessageType.DATA_MESSAGE, "retry_count"}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(i));
                if (!cursorQuery.moveToFirst()) {
    ...
    private final boolean zza(String str, int i, zzbv.zzb zzbVar) throws IllegalStateException {
        ...
        contentValues.put(Constants.ScionAnalytics.MessageType.DATA_MESSAGE, bArrZzbk);
        try {
    ...
    */
    ...
    final Map<Integer, List<zzbv.zzb>> zze(String str) {
        ...
        try {
            try {
                Cursor cursorQuery = c_().query("event_filters", new String[]{"audience_id", Constants.ScionAnalytics.MessageType.DATA_MESSAGE}, "app_id=?", new String[]{str}, null, null, null);
                if (!cursorQuery.moveToFirst()) {
    ...
    */
    ...
    public final long zza(zzcd.zzg zzgVar) throws IllegalStateException, IOException {
        ...
        contentValues.put("metadata", bArrZzbk);
        try {
    ...
    */
    ...
    final void zza(String str, List<zzbv.zza> list) {
        ...
        Preconditions.checkNotNull(list);
        for (int i = 0; i < list.size(); i++) {
            zzbv.zza.C0012zza c0012zzaZzbo = list.get(i).zzbo();
            if (c0012zzaZzbo.zzb() != 0) {
                for (int i2 = 0; i2 < c0012zzaZzbo.zzb(); i2++) {
                    zzbv.zzb.zza zzaVarZzbo = c0012zzaZzbo.zzb(i2).zzbo();
                    ...
                    if (z2) {
                        c0012zzaZzbo = c0012zzaZzbo.zza(i2, zzaVar);
                        list.set(i, (zzbv.zza) ((com.google.android.gms.internal.measurement.zzhy) c0012zzaZzbo.zzy()));
                    }
                }
            }
            if (c0012zzaZzbo.zza() != 0) {
                for (int i4 = 0; i4 < c0012zzaZzbo.zza(); i4++) {
                    zzbv.zze zzeVarZza = c0012zzaZzbo.zza(i4);
                    String strZza2 = zzgx.zza(zzeVarZza.zzc());
                    if (strZza2 != null) {
                        c0012zzaZzbo = c0012zzaZzbo.zza(i4, zzeVarZza.zzbo().zza(strZza2));
                        list.set(i, (zzbv.zza) ((com.google.android.gms.internal.measurement.zzhy) c0012zzaZzbo.zzy()));
                    }
                }
            }
