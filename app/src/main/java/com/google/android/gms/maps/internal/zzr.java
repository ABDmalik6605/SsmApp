...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0049zza implements zzr {
        ...
        public static zzr zzdM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzr)) ? new C0049zza(iBinder) : (zzr) iInterfaceQueryLocalInterface;
        }
