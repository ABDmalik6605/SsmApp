...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0048zza implements zzq {
        ...
        public static zzq zzdL(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzq)) ? new C0048zza(iBinder) : (zzq) iInterfaceQueryLocalInterface;
        }
