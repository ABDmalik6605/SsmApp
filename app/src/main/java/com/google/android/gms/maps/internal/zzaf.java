...
public interface zzaf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaf {
        ...
        private static class C0031zza implements zzaf {
        ...
        public static zzaf zzea(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzaf)) ? new C0031zza(iBinder) : (zzaf) iInterfaceQueryLocalInterface;
        }
