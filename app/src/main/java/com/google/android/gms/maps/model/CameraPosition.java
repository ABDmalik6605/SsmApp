...
public final class CameraPosition extends com.google.android.gms.common.internal.safeparcel.zza implements ReflectedParcelable {
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        ...
        zzac.zzb(0.0f <= f2 && f2 <= 90.0f, "Tilt needs to be between 0 and 90 inclusive: %s", new Object[]{Float.valueOf(f2)});
        this.target = latLng;
        this.zoom = f;
        this.tilt = f2 + 0.0f;
    ...
    public String toString() {
        return zzaa.zzv(this).zzg(TypedValues.AttributesType.S_TARGET, this.target).zzg("zoom", Float.valueOf(this.zoom)).zzg("tilt", Float.valueOf(this.tilt)).zzg("bearing", Float.valueOf(this.bearing)).toString();
    }
