...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IUiSettingsDelegate {
        ...
        private static class C0025zza implements IUiSettingsDelegate {
        ...
        public static IUiSettingsDelegate zzeg(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IUiSettingsDelegate)) ? new C0025zza(iBinder) : (IUiSettingsDelegate) iInterfaceQueryLocalInterface;
        }
