...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapFragmentDelegate {
        ...
        private static class C0019zza implements IMapFragmentDelegate {
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    return IGoogleMapDelegate.zza.zzdu(parcelObtain2.readStrongBinder());
                } finally {
        ...
        public static IMapFragmentDelegate zzdx(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMapFragmentDelegate)) ? new C0019zza(iBinder) : (IMapFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 4:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    IObjectWrapper iObjectWrapperOnCreateView = onCreateView(IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(iObjectWrapperOnCreateView != null ? iObjectWrapperOnCreateView.asBinder() : null);
                    return true;
                case 5:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onResume();
