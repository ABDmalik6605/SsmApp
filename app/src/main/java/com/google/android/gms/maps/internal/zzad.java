...
public interface zzad extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzad {
        ...
        private static class C0029zza implements zzad {
        ...
        public static zzad zzdY(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzad)) ? new C0029zza(iBinder) : (zzad) iInterfaceQueryLocalInterface;
        }
