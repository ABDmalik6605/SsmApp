    ...
    static class zza implements StreetViewLifecycleDelegate {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            try {
                Bundle bundle2 = new Bundle();
                zzah.zzd(bundle, bundle2);
                IObjectWrapper iObjectWrapperOnCreateView = this.zzboG.onCreateView(zzd.zzA(layoutInflater), zzd.zzA(viewGroup), bundle2);
                zzah.zzd(bundle2, bundle);
    ...
    static class zzb extends com.google.android.gms.dynamic.zza<zza> {
        ...
        public void zzJz() {
            ...
            try {
                ...
                Iterator<OnStreetViewPanoramaReadyCallback> it = this.zzboI.iterator();
                while (it.hasNext()) {
                    ((zza) zzBN()).getStreetViewPanoramaAsync(it.next());
                }
                this.zzboI.clear();
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
