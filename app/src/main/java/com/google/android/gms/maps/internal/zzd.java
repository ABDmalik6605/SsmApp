    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                IObjectWrapper iObjectWrapperZzh = zzh(zzf.zza.zzen(parcel.readStrongBinder()));
                parcel2.writeNoException();
                parcel2.writeStrongBinder(iObjectWrapperZzh != null ? iObjectWrapperZzh.asBinder() : null);
                return true;
            }
            if (i != 2) {
                if (i != 1598968902) {
            ...
            parcel.enforceInterface("com.google.android.gms.maps.internal.IInfoWindowAdapter");
            IObjectWrapper iObjectWrapperZzi = zzi(zzf.zza.zzen(parcel.readStrongBinder()));
            parcel2.writeNoException();
