...
public class SupportMapFragment extends Fragment {
    ...
    static class zza implements MapLifecycleDelegate {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            try {
                Bundle bundle2 = new Bundle();
                zzah.zzd(bundle, bundle2);
                IObjectWrapper iObjectWrapperOnCreateView = this.zzbop.onCreateView(zzd.zzA(layoutInflater), zzd.zzA(viewGroup), bundle2);
                zzah.zzd(bundle2, bundle);
                return (View) zzd.zzF(iObjectWrapperOnCreateView);
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        }
    ...
    static class zzb extends com.google.android.gms.dynamic.zza<zza> {
        ...
        public void zzJz() {
            ...
            try {
                ...
                IMapFragmentDelegate iMapFragmentDelegateZzI = zzai.zzbI(this.mActivity).zzI(zzd.zzA(this.mActivity));
                if (iMapFragmentDelegateZzI == null) {
                    return;
                }
                this.zzbor.zza(new zza(this.zzaRN, iMapFragmentDelegateZzI));
                Iterator<OnMapReadyCallback> it = this.zzbos.iterator();
                while (it.hasNext()) {
                    ((zza) zzBN()).getMapAsync(it.next());
                }
                this.zzbos.clear();
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
    ...
    @Override // androidx.fragment.app.Fragment
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewOnCreateView = this.zzboU.onCreateView(layoutInflater, viewGroup, bundle);
