...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, SimpleMonthView.VIEW_PARAMS_HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.5
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(SimpleMonthView.VIEW_PARAMS_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(SimpleMonthView.VIEW_PARAMS_HEIGHT);
                propertyValues2[0].setFloatValues(ExtendedFloatingActionButton.this.getHeight(), this.size.getHeight());
                currentMotionSpec.setPropertyValues(SimpleMonthView.VIEW_PARAMS_HEIGHT, propertyValues2);
            }
