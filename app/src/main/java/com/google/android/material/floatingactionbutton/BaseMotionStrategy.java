...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(SimpleMonthView.VIEW_PARAMS_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(SimpleMonthView.VIEW_PARAMS_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
