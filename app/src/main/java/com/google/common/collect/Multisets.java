...
public final class Multisets {
    ...
    public static <T, E, M extends Multiset<E>> Collector<T, ?, M> toMultiset(final Function<? super T, E> function, final ToIntFunction<? super T> toIntFunction, Supplier<M> supplier) {
        ...
        return Collector.of(supplier, new BiConsumer() { // from class: com.google.common.collect.-$$Lambda$Multisets$HDmn3JWzcoR-FArNGkQgyRA5_C8
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ((Multiset) obj).add(function.apply(obj2), toIntFunction.applyAsInt(obj2));
            }
        }, new BinaryOperator() { // from class: com.google.common.collect.-$$Lambda$Multisets$JxTo_4F9q3pBsyIfwUOATcU-oW0
    ...
    private static <E> boolean addAllImpl(final Multiset<E> multiset, Multiset<? extends E> multiset2) {
        ...
        multiset.getClass();
        multiset2.forEachEntry(new ObjIntConsumer() { // from class: com.google.common.collect.-$$Lambda$TLkZAI8eOVkj-PWTvpgIx13WwqY
    ...
    public static <E> Spliterator<E> spliteratorImpl(Multiset<E> multiset) {
        ...
        return CollectSpliterators.flatMap(spliterator, new Function() { // from class: com.google.common.collect.-$$Lambda$Multisets$1Pm_PPj6Y5hq9vBLYJJ99caiaEM
