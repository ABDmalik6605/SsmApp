...
public final class Maps {
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.collect.-$$Lambda$Maps$yAIUrZ8q26ye78e1ZXi7biToqsA
            ...
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ((Maps.Accumulator) obj).put((Enum) Preconditions.checkNotNull(function.apply(obj2), "Null key for input %s", obj2), Preconditions.checkNotNull(function2.apply(obj2), "Null value for input %s", obj2));
            }
    ...
    static /* synthetic */ Accumulator lambda$toImmutableEnumMap$1() {
        return new Accumulator(new BinaryOperator() { // from class: com.google.common.collect.-$$Lambda$Maps$s23jX6yQEOpzR7a55Uiq-cBAFqo
    ...
    public static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final java.util.function.Function<? super T, ? extends K> function, final java.util.function.Function<? super T, ? extends V> function2, final BinaryOperator<V> binaryOperator) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.collect.-$$Lambda$Maps$l5ejJDJGwWoW_p5UkaxKxEJYBSo
            @Override // java.util.function.Supplier
            public final Object get() {
        ...
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            ...
            backingSet().forEach(new Consumer() { // from class: com.google.common.collect.-$$Lambda$Maps$AsMapView$N-1U7hmvOVklGaSkMXpG85PCCNI
                ...
                public final void accept(Object obj) {
                    this.f$0.lambda$forEach$0$Maps$AsMapView(biConsumer, obj);
                }
            });
        }
    ...
    static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.map(this.set.spliterator(), new java.util.function.Function() { // from class: com.google.common.collect.-$$Lambda$Maps$NavigableAsMapView$UbjZUgssgvFGFsmcMSG_On-Ucgk
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return this.f$0.lambda$entrySpliterator$0$Maps$NavigableAsMapView(obj);
                }
            });
        }
        ...
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            this.set.forEach(new Consumer() { // from class: com.google.common.collect.-$$Lambda$Maps$NavigableAsMapView$wNZFNyJKuFJOv_35xtEMijfSrSM
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$forEach$1$Maps$NavigableAsMapView(biConsumer, obj);
                }
            });
        }
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public void forEach(final BiConsumer<? super K, ? super V2> biConsumer) {
            ...
            this.fromMap.forEach(new BiConsumer() { // from class: com.google.common.collect.-$$Lambda$Maps$TransformedEntriesMap$G0ImAkyYFsKeWifoHo_DEkteFv8
                @Override // java.util.function.BiConsumer
                public final void accept(Object obj, Object obj2) {
                    this.f$0.lambda$forEach$0$Maps$TransformedEntriesMap(biConsumer, obj, obj2);
                }
            });
        }
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
            unfiltered().replaceAll(new BiFunction() { // from class: com.google.common.collect.-$$Lambda$Maps$FilteredEntryBiMap$xbLLZzLvN6p9touJRRU50JOVXWA
                @Override // java.util.function.BiFunction
                public final Object apply(Object obj, Object obj2) {
                    return this.f$0.lambda$replaceAll$0$Maps$FilteredEntryBiMap(biFunction, obj, obj2);
                }
            });
        }
