...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), new Function() { // from class: com.google.common.collect.-$$Lambda$StandardTable$Vzxo9oL8hvAQvGq0nepV6fnu_bc
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Map.Entry entry = (Map.Entry) obj;
                return CollectSpliterators.map(((Map) entry.getValue()).entrySet().spliterator(), new Function() { // from class: com.google.common.collect.-$$Lambda$StandardTable$b5KCTRKsVw5Vk3tTlu1kD6NHDME
                    @Override // java.util.function.Function
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(mapBackingRowMap.entrySet().spliterator(), new Function() { // from class: com.google.common.collect.-$$Lambda$8ll8pi4fSeHLARe5o2NUv_CDysA
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
