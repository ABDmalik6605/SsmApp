...
final class Synchronized {
    ...
    static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E> {
        ...
        public Stream<E> parallelStream() {
            Stream<E> streamParallelStream;
            synchronized (this.mutex) {
                streamParallelStream = delegate().parallelStream();
            }
            return streamParallelStream;
        }
        ...
        public boolean removeIf(Predicate<? super E> predicate) {
            boolean zRemoveIf;
            synchronized (this.mutex) {
                zRemoveIf = delegate().removeIf(predicate);
            }
            return zRemoveIf;
        }
    ...
    private static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
        ...
        public V putIfAbsent(K k, V v) {
            V vPutIfAbsent;
            synchronized (this.mutex) {
                vPutIfAbsent = delegate().putIfAbsent(k, v);
            }
            return vPutIfAbsent;
        }
        ...
        public boolean replace(K k, V v, V v2) {
            boolean zReplace;
            synchronized (this.mutex) {
                zReplace = delegate().replace(k, v, v2);
            }
            return zReplace;
        }
        ...
        public V computeIfAbsent(K k, Function<? super K, ? extends V> function) {
            V vComputeIfAbsent;
            synchronized (this.mutex) {
                vComputeIfAbsent = delegate().computeIfAbsent(k, function);
            }
        ...
        public V computeIfPresent(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            V vComputeIfPresent;
            synchronized (this.mutex) {
                vComputeIfPresent = delegate().computeIfPresent(k, biFunction);
            }
        ...
        public V compute(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            V vCompute;
            synchronized (this.mutex) {
                vCompute = delegate().compute(k, biFunction);
            }
            return vCompute;
        }
        ...
        public V merge(K k, V v, BiFunction<? super V, ? super V, ? extends V> biFunction) {
            V vMerge;
            synchronized (this.mutex) {
                vMerge = delegate().merge(k, v, biFunction);
            }
            return vMerge;
        }
