...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public void forEachEntry(ObjIntConsumer<? super E> objIntConsumer) {
        ...
        for (AvlNode<E> avlNodeFirstNode = firstNode(); avlNodeFirstNode != this.header && avlNodeFirstNode != null && !this.range.tooHigh(avlNodeFirstNode.getElement()); avlNodeFirstNode = ((AvlNode) avlNodeFirstNode).succ) {
            objIntConsumer.accept(avlNodeFirstNode.getElement(), avlNodeFirstNode.getCount());
        }
    }
