...
public final class Iterables {
    ...
    static class AnonymousClass1<T> extends FluentIterable<T> {
        ...
        public Spliterator<T> spliterator() {
            ...
            return Stream.generate(new Supplier() { // from class: com.google.common.collect.-$$Lambda$Iterables$1$qiRIPtE9tWucoD2gTAzjgEVZv2Y
                @Override // java.util.function.Supplier
                public final Object get() {
                    return Iterables.AnonymousClass1.lambda$spliterator$0(iterable);
                }
            }).flatMap(new Function() { // from class: com.google.common.collect.-$$Lambda$vebnCuY8ziEmDivclpgyaIK1QGk
    ...
    static class AnonymousClass4<T> extends FluentIterable<T> {
        ...
        public void forEach(final Consumer<? super T> consumer) {
            ...
            iterable.forEach(new Consumer() { // from class: com.google.common.collect.-$$Lambda$Iterables$4$rSuZgfYtzR9N1C-t8FWfAtX17Dc
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Iterables.AnonymousClass4.lambda$forEach$0(predicate, consumer, obj);
                }
            });
        }
    ...
    static class AnonymousClass5<T> extends FluentIterable<T> {
        ...
        public void forEach(final Consumer<? super T> consumer) {
            ...
            iterable.forEach(new Consumer() { // from class: com.google.common.collect.-$$Lambda$Iterables$5$QKcSfRaeGfNF5T0jqcGPOfebu1c
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
