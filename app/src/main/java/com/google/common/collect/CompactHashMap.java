...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class EntrySetView extends Maps.EntrySet<K, V> {
        ...
        public Spliterator<Map.Entry<K, V>> spliterator() {
            return CollectSpliterators.indexed(CompactHashMap.this.size, 17, new IntFunction() { // from class: com.google.common.collect.-$$Lambda$CompactHashMap$EntrySetView$1h2umnSNJpNlW-oDLf8VOcBKp6Q
                @Override // java.util.function.IntFunction
                public final Object apply(int i) {
                    return this.f$0.lambda$spliterator$0$CompactHashMap$EntrySetView(i);
                }
            });
        }
