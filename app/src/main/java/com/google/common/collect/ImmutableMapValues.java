...
final class ImmutableMapValues<K, V> extends ImmutableCollection<V> {
    ...
    public Spliterator<V> spliterator() {
        return CollectSpliterators.map(this.map.entrySet().spliterator(), $$Lambda$kPj8Ioh2qrHaOpflIdB8Zk2L0PY.INSTANCE);
    }
    ...
    public void forEach(final Consumer<? super V> consumer) {
        ...
        this.map.forEach(new BiConsumer() { // from class: com.google.common.collect.-$$Lambda$ImmutableMapValues$uQ2dXKWiTIQ6CSy7IcVv7zBRQ0U
