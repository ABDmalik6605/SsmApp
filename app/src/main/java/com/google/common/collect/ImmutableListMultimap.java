...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> toImmutableListMultimap(final Function<? super T, ? extends K> function, final Function<? super T, ? extends V> function2) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.collect.-$$Lambda$uo6mGZv0bsq-gnHJiRrqi7rbatA
            @Override // java.util.function.Supplier
            public final Object get() {
                return ImmutableListMultimap.builder();
            }
        }, new BiConsumer() { // from class: com.google.common.collect.-$$Lambda$ImmutableListMultimap$QowoRyuFcvBo4MSZ38DjEz8zmEs
        ...
        }, new BinaryOperator() { // from class: com.google.common.collect.-$$Lambda$ccIXdoLJAFjjZ8yRnyPiUG74_nY
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                return ((ImmutableListMultimap.Builder) obj).combine((ImmutableMultimap.Builder) obj2);
            }
        }, new Function() { // from class: com.google.common.collect.-$$Lambda$ywKRZI1iCBhL1O7ykEl8_5kBSK0
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> flatteningToImmutableListMultimap(final Function<? super T, ? extends K> function, final Function<? super T, ? extends Stream<? extends V>> function2) {
        ...
        Function function3 = new Function() { // from class: com.google.common.collect.-$$Lambda$ImmutableListMultimap$JVQU60JPMtMEyBSddeb0Swk_8VY
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return Preconditions.checkNotNull(function.apply(obj));
            }
        };
        Function function4 = new Function() { // from class: com.google.common.collect.-$$Lambda$ImmutableListMultimap$oJe5KNvGW0sZPENGGx4sPGYoOVU
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return ((Stream) function2.apply(obj)).peek($$Lambda$3Zdf5F0rNx9_HL1xP9EFYzhGfgM.INSTANCE);
            }
        };
        ...
        return Collectors.collectingAndThen(Multimaps.flatteningToMultimap(function3, function4, new Supplier() { // from class: com.google.common.collect.-$$Lambda$VB50dy0bHvmi2ab6fUqhh1JbVWE
            @Override // java.util.function.Supplier
            public final Object get() {
                return listMultimapBuilderArrayListValues.build();
            }
        }), new Function() { // from class: com.google.common.collect.-$$Lambda$gecpByN4eJJvQ5D8bhEGkiZE_kw
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
