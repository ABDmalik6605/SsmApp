...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    class AnonymousClass2 extends ForwardingSet<Map.Entry<Class<? extends B>, B>> {
        ...
        public Spliterator<Map.Entry<Class<? extends B>, B>> spliterator() {
            return CollectSpliterators.map(delegate().spliterator(), new Function() { // from class: com.google.common.collect.-$$Lambda$MutableClassToInstanceMap$2$du35t0Jw_CJxPphpPFF15FKxWZg
