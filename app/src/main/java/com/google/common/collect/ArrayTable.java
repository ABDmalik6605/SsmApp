...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.common.collect.-$$Lambda$Oyw8C3EXhbr8RstpeKamFQ-SsGk
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.indexed(size(), 273, new IntFunction() { // from class: com.google.common.collect.-$$Lambda$ArrayTable$zTKS5BxTstixK4BzUflA6FnJJlE
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
    ...
    Spliterator<V> valuesSpliterator() {
        return CollectSpliterators.indexed(size(), 16, new IntFunction() { // from class: com.google.common.collect.-$$Lambda$ArrayTable$yqJBEUhtD7sOM-8hNQp9h3Mi57Y
            @Override // java.util.function.IntFunction
            public final Object apply(int i) {
                return this.f$0.getValue(i);
            }
        });
    }
}
