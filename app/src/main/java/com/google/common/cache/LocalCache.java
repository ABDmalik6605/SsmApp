...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        V compute(K k, int i, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            ...
            try {
                ...
                V vCompute = loadingValueReference.compute(k, biFunction);
                if (vCompute != null) {
                    try {
                        return getAndRecordStats(k, i, loadingValueReference, Futures.immediateFuture(vCompute));
                ...
                if (z2) {
                    ...
                    removeEntry(referenceEntryNewEntry, i, RemovalCause.EXPLICIT);
                }
                return null;
            } finally {
                unlock();
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public V compute(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            FormatUtil formatUtilWaitForValue;
            this.stopwatch.start();
            try {
                formatUtilWaitForValue = this.oldValue.waitForValue();
            } catch (ExecutionException unused) {
                formatUtilWaitForValue = null;
            }
            V vApply = biFunction.apply(k, formatUtilWaitForValue);
            set(vApply);
            return vApply;
        }
    ...
    */
    ...
    public V compute(K k, BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        int iHash = hash(k);
        return segmentFor(iHash).compute(k, iHash, biFunction);
    }
    ...
    public V computeIfAbsent(final K k, final java.util.function.Function<? super K, ? extends V> function) {
        ...
        return compute(k, new BiFunction() { // from class: com.google.common.cache.-$$Lambda$LocalCache$_WwkUFbVbttGViG-f6jdpuXJ7bw
    ...
    public V computeIfPresent(K k, final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        Preconditions.checkNotNull(k);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.common.cache.-$$Lambda$LocalCache$vJVeDGGoF7EUhjhtnAVXQs8CnU0
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    public V merge(K k, final V v, final BiFunction<? super V, ? super V, ? extends V> biFunction) {
        ...
        Preconditions.checkNotNull(v);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.common.cache.-$$Lambda$LocalCache$GZ-zfBzaDmOFoCrgoBVM5YvBNJ0
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean removeIf(final Predicate<? super V> predicate) {
            ...
            return LocalCache.this.removeIf(new BiPredicate() { // from class: com.google.common.cache.-$$Lambda$LocalCache$Values$Ym3sLsdmuSfnVutzdWg2f1NtHbs
    ...
    final class EntrySet extends LocalCache<K, V>.AbstractCacheSet<Map.Entry<K, V>> {
        ...
        public boolean removeIf(final Predicate<? super Map.Entry<K, V>> predicate) {
            Preconditions.checkNotNull(predicate);
            return LocalCache.this.removeIf(new BiPredicate() { // from class: com.google.common.cache.-$$Lambda$LocalCache$EntrySet$wyX9Fr3AG0HGMyfXw_doqMI5_xM
                @Override // java.util.function.BiPredicate
                public final boolean test(Object obj, Object obj2) {
