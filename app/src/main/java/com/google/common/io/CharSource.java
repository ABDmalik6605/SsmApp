...
public abstract class CharSource {
    ...
    public Stream<String> lines() throws IOException {
        ...
        return (Stream) bufferedReaderOpenBufferedStream.lines().onClose(new Runnable() { // from class: com.google.common.io.-$$Lambda$CharSource$uWfacz9Bc4sFbLcPwYQKSuikcM0
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                CharSource.lambda$lines$0(bufferedReaderOpenBufferedStream);
            }
        });
    }

    static /* synthetic */ void lambda$lines$0(BufferedReader bufferedReader) throws IOException {
        try {
