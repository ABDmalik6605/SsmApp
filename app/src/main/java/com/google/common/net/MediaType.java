...
public final class MediaType {
    ...
    public static final MediaType JPEG = createConstant(IMAGE_TYPE, Camera.IMAGE_JPEG);
    public static final MediaType PNG = createConstant(IMAGE_TYPE, Camera.IMAGE_PNG);
