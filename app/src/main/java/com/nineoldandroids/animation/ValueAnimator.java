...
public class ValueAnimator extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo67clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo67clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo71clone = propertyValuesHolderArr[i2].mo71clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo71clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo71clone.getPropertyName(), propertyValuesHolderMo71clone);
            }
        }
        return valueAnimator;
    }
