...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m76boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m77constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m82hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    private static final T m81getOrNullimpl(Object obj) {
        if (m83isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static String m85toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m77constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m77constructorimpl(ResultKt.createFailure(exception));
        }
    }
