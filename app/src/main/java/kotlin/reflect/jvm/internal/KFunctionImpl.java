...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public FunctionCaller<?> getDefaultCaller() {
        return (FunctionCaller) this.defaultCaller.getValue(this, $$delegatedProperties[2]);
    }
    ...
    private KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, final String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.caller = ReflectProperties.lazySoft(new Function0<FunctionCaller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$caller$2
            {
                super(0);
            }
            ...
            public final FunctionCaller<? extends Member> invoke() {
                ...
                FunctionCaller.Method methodCreateJvmStaticInObjectCaller;
                ...
                if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinConstructor) {
                    ...
                    constructor = this.this$0.getContainer().findConstructorBySignature(((JvmFunctionSignature.KotlinConstructor) jvmFunctionSignatureMapSignature).getConstructorDesc(), UtilKt.isPublicInBytecode(this.this$0.getDescriptor()));
                    ...
                    constructor = this.this$0.getContainer().findMethodBySignature(kotlinFunction.getMethodName(), kotlinFunction.getMethodDesc(), UtilKt.isPublicInBytecode(this.this$0.getDescriptor()));
                ...
                if (constructor instanceof Constructor) {
                    return this.this$0.createConstructorCaller((Constructor) constructor);
                }
                if (constructor instanceof Method) {
                    ...
                    if (!Modifier.isStatic(method.getModifiers())) {
                        ...
                        methodCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo1326findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    }
                    return methodCreateJvmStaticInObjectCaller;
                }
        ...
        this.defaultCaller = ReflectProperties.lazySoft(new Function0<FunctionCaller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            {
                super(0);
            }
            ...
            */
            public final kotlin.reflect.jvm.internal.FunctionCaller<? extends java.lang.reflect.Member> invoke() {
                /*
                    Method dump skipped, instructions count: 367
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2.invoke():kotlin.reflect.jvm.internal.FunctionCaller");
            }
        });
    }
    ...
    public final FunctionCaller.Method createStaticMethodCaller(Method member) {
        return isBound() ? new FunctionCaller.BoundStaticMethod(member, this.boundReceiver) : new FunctionCaller.StaticMethod(member);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final FunctionCaller.Method createJvmStaticInObjectCaller(Method member) {
        return isBound() ? new FunctionCaller.BoundJvmStaticInObject(member) : new FunctionCaller.JvmStaticInObject(member);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final FunctionCaller.Method createInstanceMethodCaller(Method member) {
        return isBound() ? new FunctionCaller.BoundInstanceMethod(member, this.boundReceiver) : new FunctionCaller.InstanceMethod(member);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final FunctionCaller<Constructor<?>> createConstructorCaller(Constructor<?> member) {
        return isBound() ? new FunctionCaller.BoundConstructor(member, this.boundReceiver) : new FunctionCaller.Constructor(member);
    }
