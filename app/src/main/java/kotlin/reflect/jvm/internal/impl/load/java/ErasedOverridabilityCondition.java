    ...
    public ExternalOverridabilityCondition.Result isOverridable(CallableDescriptor superDescriptor, CallableDescriptor subDescriptor, ClassDescriptor classDescriptor) {
        ...
        if (subDescriptor instanceof JavaMethodDescriptor) {
            ...
            if (!(!r0.isEmpty())) {
                ...
                FunctionDescriptor functionDescriptorSubstitute = superDescriptor.substitute(RawSubstitution.INSTANCE.buildSubstitutor());
                ...
                OverridingUtil.OverrideCompatibilityInfo overrideCompatibilityInfoIsOverridableByWithoutExternalConditions = OverridingUtil.DEFAULT.isOverridableByWithoutExternalConditions(functionDescriptorSubstitute, subDescriptor, false);
                Intrinsics.checkExpressionValueIsNotNull(overrideCompatibilityInfoIsOverridableByWithoutExternalConditions, "OverridingUtil.DEFAULT.i…er, subDescriptor, false)");
                if (WhenMappings.$EnumSwitchMapping$0[overrideCompatibilityInfoIsOverridableByWithoutExternalConditions.getResult().ordinal()] == 1) {
