...
public abstract class TypeSubstitution {
    ...
    public static final TypeSubstitution EMPTY = new TypeSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.TypeSubstitution$Companion$EMPTY$1
        ...
        public /* bridge */ /* synthetic */ TypeProjection mo1341get(KotlinType kotlinType) {
    ...
    /* renamed from: get */
    public abstract TypeProjection mo1341get(KotlinType kotlinType);
    ...
    public final TypeSubstitutor buildSubstitutor() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(typeSubstitutorCreate, "TypeSubstitutor.create(this)");
