...
public interface ClassConstructorDescriptor extends ConstructorDescriptor {
    ...
    ClassConstructorDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, Visibility visibility, CallableMemberDescriptor.Kind kind, boolean z);
