...
public final class KMutableProperty0Impl<R> extends KProperty0Impl<R> implements KMutableProperty0<R> {
    ...
    public KMutableProperty0Impl(KDeclarationContainerImpl container, PropertyDescriptor descriptor) {
        ...
        this._setter = ReflectProperties.lazy(new Function0<Setter<R>>() { // from class: kotlin.reflect.jvm.internal.KMutableProperty0Impl$_setter$1
            {
                super(0);
            }
    ...
    public Setter<R> getSetter() {
        Setter<R> setterInvoke = this._setter.invoke();
        Intrinsics.checkExpressionValueIsNotNull(setterInvoke, "_setter()");
        return setterInvoke;
    }
