...
public final class ReflectionTypes {
    ...
    public ReflectionTypes(final ModuleDescriptor module, NotFoundClasses notFoundClasses) {
        ...
        this.kotlinReflectScope$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.ReflectionTypes$kotlinReflectScope$2
            ...
            public final MemberScope invoke() {
                return module.getPackage(ReflectionTypesKt.getKOTLIN_REFLECT_FQ_NAME()).getMemberScope();
            }
        });
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor contributedClassifier = kotlinReflectScope.mo1334getContributedClassifier(name, NoLookupLocation.FROM_REFLECTION);
    ...
    public static final class Companion {
        ...
        public final KotlinType createKPropertyStarType(ModuleDescriptor module) {
            ...
            TypeConstructor typeConstructor = classDescriptorFindClassAcrossModuleDependencies.getTypeConstructor();
            ...
            Intrinsics.checkExpressionValueIsNotNull(objSingle, "kPropertyClass.typeConstructor.parameters.single()");
