...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        while (it3.hasNext()) {
            arrayList3.add(TuplesKt.to((Class) it3.next(), Integer.valueOf(i)));
            i++;
        }
        FUNCTION_CLASSES = MapsKt.toMap(arrayList3);
    }

    public static final Class<?> getPrimitiveByWrapper(Class<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        return WRAPPER_TO_PRIMITIVE.get(receiver);
    }

    public static final Class<?> getWrapperByPrimitive(Class<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        return PRIMITIVE_TO_WRAPPER.get(receiver);
    }

    public static final Integer getFunctionClassArity(Class<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        return FUNCTION_CLASSES.get(receiver);
    }
    ...
    public static final ClassId getClassId(Class<?> receiver) {
        ...
        if (receiver.getEnclosingMethod() == null && receiver.getEnclosingConstructor() == null) {
            ...
            if (!(simpleName.length() == 0)) {
                ...
                if (declaringClass != null && (classId = getClassId(declaringClass)) != null && (classIdCreateNestedClassId = classId.createNestedClassId(Name.identifier(receiver.getSimpleName()))) != null) {
                    return classIdCreateNestedClassId;
                }
                ClassId classId2 = ClassId.topLevel(new FqName(receiver.getName()));
                Intrinsics.checkExpressionValueIsNotNull(classId2, "ClassId.topLevel(FqName(name))");
                return classId2;
            }
        }
        FqName fqName = new FqName(receiver.getName());
    ...
    public static final String getDesc(Class<?> receiver) {
        ...
        return StringsKt.replace$default(strSubstring, ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', false, 4, (Object) null);
    }
    ...
    public static final List<Type> getParameterizedTypeArguments(Type receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        ...
        if (parameterizedType.getOwnerType() != null) {
            return SequencesKt.toList(SequencesKt.flatMap(SequencesKt.generateSequence(receiver, new Function1<ParameterizedType, ParameterizedType>() { // from class: kotlin.reflect.jvm.internal.structure.ReflectClassUtilKt$parameterizedTypeArguments$1
