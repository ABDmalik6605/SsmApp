...
final class IsKPropertyCheck implements Check {
    ...
    public boolean check(FunctionDescriptor functionDescriptor) {
        ...
        KotlinType kotlinTypeMakeNotNullable = TypeUtilsKt.makeNotNullable(type);
        Intrinsics.checkExpressionValueIsNotNull(kotlinTypeMakeNotNullable, "secondParameter.type.makeNotNullable()");
        return TypeUtilsKt.isSubtypeOf(kotlinTypeCreateKPropertyStarType, kotlinTypeMakeNotNullable);
    }
}
