...
public final class SuspendFunctionTypesKt {
    ...
    public static final SimpleType transformSuspendFunctionToRuntimeFunctionType(KotlinType suspendFunType, boolean z) {
        ...
        List listPlus = CollectionsKt.plus((Collection<? extends SimpleType>) arrayList2, KotlinTypeFactory.simpleType(empty, typeConstructor, CollectionsKt.listOf(TypeUtilsKt.asTypeProjection(FunctionTypesKt.getReturnTypeFromFunctionType(suspendFunType))), false));
        ...
        return FunctionTypesKt.createFunctionType(builtIns, annotations, receiverTypeFromFunctionType, listPlus, null, nullableAnyType, (64 & 64) != 0 ? false : false).makeNullableAsSpecified(suspendFunType.isMarkedNullable());
    }
