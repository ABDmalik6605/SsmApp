...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    public DeserializedTypeParameterDescriptor(DeserializationContext c, ProtoBuf.TypeParameter proto, int i) {
        ...
        this.annotations = new DeserializedAnnotations(c.getStorageManager(), new Function0<List<? extends AnnotationDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedTypeParameterDescriptor$annotations$1
            ...
            public final List<? extends AnnotationDescriptor> invoke() {
                return CollectionsKt.toList(this.this$0.c.getComponents().getAnnotationAndConstantLoader().loadTypeParameterAnnotations(this.this$0.proto, this.this$0.c.getNameResolver()));
            }
        });
    }
    ...
    protected List<KotlinType> resolveUpperBounds() {
        ...
        while (it.hasNext()) {
            arrayList.add(this.c.getTypeDeserializer().type((ProtoBuf.Type) it.next(), Annotations.Companion.getEMPTY()));
        }
        return arrayList;
    }
    ...
    public Void mo1340reportSupertypeLoopError(KotlinType type) {
