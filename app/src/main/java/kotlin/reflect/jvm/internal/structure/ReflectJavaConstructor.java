...
public final class ReflectJavaConstructor extends ReflectJavaMember implements JavaConstructor {
    ...
    public List<JavaValueParameter> getValueParameters() {
        ...
        if (annotationArr.length > realTypes.length) {
            ...
            Object[] objArrCopyOfRange2 = Arrays.copyOfRange(annotationArr, annotationArr.length - realTypes.length, annotationArr.length);
            Intrinsics.checkExpressionValueIsNotNull(objArrCopyOfRange2, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
            realAnnotations = (Annotation[][]) objArrCopyOfRange2;
        }
