...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areCallableDescriptorsEquivalent(final CallableDescriptor a, final CallableDescriptor b, boolean z) {
        ...
        if (!DescriptorUtils.isLocal(callableDescriptor)) {
            ...
            OverridingUtil overridingUtilCreateWithEqualityAxioms = OverridingUtil.createWithEqualityAxioms(new KotlinTypeChecker.TypeConstructorEquality() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1
                ...
                public final boolean equals(TypeConstructor c1, TypeConstructor c2) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo1333getDeclarationDescriptor = c1.mo1333getDeclarationDescriptor();
                    ClassifierDescriptor classifierDescriptorMo1333getDeclarationDescriptor2 = c2.mo1333getDeclarationDescriptor();
                    if ((classifierDescriptorMo1333getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo1333getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
                        return DescriptorEquivalenceForOverrides.INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo1333getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo1333getDeclarationDescriptor2, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1.1
                            {
                                super(2);
                            }
            ...
            OverridingUtil.OverrideCompatibilityInfo overrideCompatibilityInfoIsOverridableBy = overridingUtilCreateWithEqualityAxioms.isOverridableBy(a, b, null, !z);
            Intrinsics.checkExpressionValueIsNotNull(overrideCompatibilityInfoIsOverridableBy, "overridingUtil.isOverrid… null, !ignoreReturnType)");
            if (overrideCompatibilityInfoIsOverridableBy.getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE) {
                OverridingUtil.OverrideCompatibilityInfo overrideCompatibilityInfoIsOverridableBy2 = overridingUtilCreateWithEqualityAxioms.isOverridableBy(b, a, null, !z);
                Intrinsics.checkExpressionValueIsNotNull(overrideCompatibilityInfoIsOverridableBy2, "overridingUtil.isOverrid… null, !ignoreReturnType)");
                if (overrideCompatibilityInfoIsOverridableBy2.getResult() == OverridingUtil.OverrideCompatibilityInfo.Result.OVERRIDABLE) {
                    return true;
                }
            }
            return false;
