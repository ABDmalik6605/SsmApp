...
public final class LazyJavaAnnotationDescriptor implements AnnotationDescriptor {
    ...
    public LazyJavaAnnotationDescriptor(LazyJavaResolverContext c, JavaAnnotation javaAnnotation) {
        ...
        this.type$delegate = c.getStorageManager().createLazyValue(new Function0<SimpleType>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$type$2
            ...
            public final SimpleType invoke() {
                ...
                ClassDescriptor classDescriptorMapJavaToKotlin$default = JavaToKotlinClassMap.mapJavaToKotlin$default(javaToKotlinClassMap, fqName, this.this$0.c.getModule().getBuiltIns(), null, 4, null);
        ...
        this.allValueArguments$delegate = c.getStorageManager().createLazyValue(new Function0<Map<Name, ? extends ConstantValue<?>>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$allValueArguments$2
            ...
            public final Map<Name, ? extends ConstantValue<?>> invoke() {
                ...
                for (JavaAnnotationArgument javaAnnotationArgument : arguments) {
                    ...
                    ConstantValue constantValueResolveAnnotationArgument = this.this$0.resolveAnnotationArgument(javaAnnotationArgument);
    ...
    private final ConstantValue<?> resolveFromJavaClassObjectType(JavaType javaType) {
        KotlinType kotlinTypeMakeNotNullable = TypeUtils.makeNotNullable(this.c.getTypeResolver().transformJavaType(javaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, null, 3, null)));
        ClassDescriptor classDescriptorResolveTopLevelClass = DescriptorUtilsKt.resolveTopLevelClass(this.c.getModule(), new FqName("java.lang.Class"), NoLookupLocation.FOR_NON_TRACKED_SCOPE);
        if (classDescriptorResolveTopLevelClass == null) {
            return null;
        }
        return new KClassValue(KotlinTypeFactory.simpleNotNullType(Annotations.Companion.getEMPTY(), classDescriptorResolveTopLevelClass, CollectionsKt.listOf(new TypeProjectionImpl(kotlinTypeMakeNotNullable))));
    }
