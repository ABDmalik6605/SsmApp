...
public class KProperty2Impl<D, E, R> extends KPropertyImpl<R> implements KProperty2<D, E, R> {
    ...
    public KProperty2Impl(KDeclarationContainerImpl container, String name, String signature) {
        ...
        this._getter = ReflectProperties.lazy(new Function0<Getter<D, E, ? extends R>>() { // from class: kotlin.reflect.jvm.internal.KProperty2Impl$_getter$1
            {
                super(0);
            }
    ...
    public Getter<D, E, R> getGetter() {
        Getter<D, E, R> getterInvoke = this._getter.invoke();
        Intrinsics.checkExpressionValueIsNotNull(getterInvoke, "_getter()");
        return getterInvoke;
    }
