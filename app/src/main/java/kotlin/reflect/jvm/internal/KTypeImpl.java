...
public final class KTypeImpl implements KType {
    ...
    public final KClassifier convert(KotlinType type) {
        ...
        if (classifierDescriptorMo1333getDeclarationDescriptor instanceof ClassDescriptor) {
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo1333getDeclarationDescriptor);
            if (javaClass == null) {
                return null;
            }
            if (javaClass.isArray()) {
                ...
                KClassifier kClassifierConvert = convert(argument);
        ...
        if (classifierDescriptorMo1333getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return new KTypeParameterImpl((TypeParameterDescriptor) classifierDescriptorMo1333getDeclarationDescriptor);
        }
