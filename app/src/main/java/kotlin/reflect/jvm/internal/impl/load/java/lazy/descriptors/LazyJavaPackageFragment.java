...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.binaryClasses$delegate = lazyJavaResolverContextChildForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<Map<String, ? extends KotlinJvmBinaryClass>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaPackageFragment$binaryClasses$2
            ...
            public final Map<String, ? extends KotlinJvmBinaryClass> invoke() {
                ...
                for (String str : listFindPackageParts) {
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(jvmClassNameByInternalName, "JvmClassName.byInternalName(partName)");
                    ClassId classId = ClassId.topLevel(jvmClassNameByInternalName.getFqNameForTopLevelClassMaybeWithDollars());
                    KotlinClassFinder kotlinClassFinder = this.this$0.c.getComponents().getKotlinClassFinder();
                    Intrinsics.checkExpressionValueIsNotNull(classId, "classId");
                    KotlinJvmBinaryClass kotlinJvmBinaryClassFindKotlinClass = kotlinClassFinder.findKotlinClass(classId);
        ...
        this.annotations = lazyJavaResolverContextChildForClassOrPackage$default.getComponents().getAnnotationTypeQualifierResolver().getDisabled() ? Annotations.Companion.getEMPTY() : LazyJavaAnnotationsKt.resolveAnnotations(lazyJavaResolverContextChildForClassOrPackage$default, jPackage);
        this.partToFacade$delegate = lazyJavaResolverContextChildForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<HashMap<JvmClassName, JvmClassName>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaPackageFragment$partToFacade$2
            ...
            public final HashMap<JvmClassName, JvmClassName> invoke() {
                ...
                for (Map.Entry<String, KotlinJvmBinaryClass> entry : this.this$0.getBinaryClasses$descriptors_jvm().entrySet()) {
                    ...
                    JvmClassName partName = JvmClassName.byInternalName(key);
                    ...
                    if (i == 1) {
                        ...
                        if (multifileClassName != null) {
                            ...
                            Intrinsics.checkExpressionValueIsNotNull(jvmClassNameByInternalName, "JvmClassName.byInternalN…: continue@kotlinClasses)");
                            map2.put(partName, jvmClassNameByInternalName);
                        }
                    } else if (i == 2) {
                        Intrinsics.checkExpressionValueIsNotNull(partName, "partName");
