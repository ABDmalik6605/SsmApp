    ...
    public static final class KotlinProperty extends JvmPropertySignature {
        ...
        public KotlinProperty(PropertyDescriptor descriptor, ProtoBuf.Property proto, JvmProtoBuf.JvmPropertySignature signature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            if (signature.hasGetter()) {
                ...
                JvmMemberSignature.Field jvmFieldSignature = JvmProtoBufUtil.INSTANCE.getJvmFieldSignature(proto, nameResolver, typeTable);
                if (jvmFieldSignature != null) {
                    String strComponent1 = jvmFieldSignature.component1();
                    string = JvmAbi.getterName(strComponent1) + getManglingSuffix() + "()" + jvmFieldSignature.component2();
                } else {
