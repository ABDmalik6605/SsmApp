    ...
    public static final JavaDefaultValue lexicalCastFrom(KotlinType receiver, String value) {
        ...
        if (classifierDescriptorMo1333getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            if (classDescriptor.getKind() == ClassKind.ENUM_CLASS) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(nameIdentifier, "Name.identifier(value)");
                ClassifierDescriptor contributedClassifier = unsubstitutedInnerClassesScope.mo1334getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_BACKEND);
        ...
        KotlinType kotlinTypeMakeNotNullable = TypeUtilsKt.makeNotNullable(receiver);
