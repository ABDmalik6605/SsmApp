...
public final class UtilsKt {
            ...
            if (typeCheckingProcedureCallbacks.assertEqualTypeConstructors(constructor2, constructor)) {
                ...
                for (SubtypePathNode previous = subtypePathNode.getPrevious(); previous != null; previous = previous.getPrevious()) {
                    ...
                    if (z) {
                        ...
                        Intrinsics.checkExpressionValueIsNotNull(kotlinTypeSafeSubstitute, "TypeConstructorSubstitut…uted, Variance.INVARIANT)");
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo1333getDeclarationDescriptor = typeConstructor.mo1333getDeclarationDescriptor(); classifierDescriptorMo1333getDeclarationDescriptor != null; classifierDescriptorMo1333getDeclarationDescriptor = classifierDescriptorMo1333getDeclarationDescriptor.getContainingDeclaration()) {
            function1.invoke("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo1333getDeclarationDescriptor));
            function1.invoke("javaClass: " + classifierDescriptorMo1333getDeclarationDescriptor.getClass().getCanonicalName());
        }
