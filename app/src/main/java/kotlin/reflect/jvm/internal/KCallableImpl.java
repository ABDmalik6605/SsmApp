...
public abstract class KCallableImpl<R> implements KCallable<R> {
    private final ReflectProperties.LazySoftVal<List<Annotation>> _annotations = ReflectProperties.lazySoft(new Function0<List<? extends Annotation>>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_annotations$1
        {
            super(0);
        }
    ...
    private final ReflectProperties.LazySoftVal<ArrayList<KParameter>> _parameters = ReflectProperties.lazySoft(new Function0<ArrayList<KParameter>>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_parameters$1
        {
            super(0);
        }
        ...
        public final ArrayList<KParameter> invoke() {
            ...
            if (descriptor.getDispatchReceiverParameter() == null || this.this$0.isBound()) {
                ...
                arrayList.add(new KParameterImpl(this.this$0, 0, KParameter.Kind.INSTANCE, new Function0<ReceiverParameterDescriptor>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_parameters$1.1
                    {
                        super(0);
                    }
            ...
            if (descriptor.getExtensionReceiverParameter() != null && !this.this$0.isBound()) {
                arrayList.add(new KParameterImpl(this.this$0, i, KParameter.Kind.EXTENSION_RECEIVER, new Function0<ReceiverParameterDescriptor>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_parameters$1.2
                    {
                        super(0);
                    }
            ...
            while (i2 < size) {
                arrayList.add(new KParameterImpl(this.this$0, i, KParameter.Kind.VALUE, new Function0<ValueParameterDescriptor>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_parameters$1.3
    ...
    private final ReflectProperties.LazySoftVal<KTypeImpl> _returnType = ReflectProperties.lazySoft(new Function0<KTypeImpl>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_returnType$1
        {
            super(0);
        }
        ...
        public final KTypeImpl invoke() {
            ...
            return new KTypeImpl(returnType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_returnType$1.1
                ...
                public final Type invoke() {
                    return KCallableImpl$_returnType$1.this.this$0.getCaller().getReturnType();
                }
            });
        }
    });
    private final ReflectProperties.LazySoftVal<List<KTypeParameterImpl>> _typeParameters = ReflectProperties.lazySoft(new Function0<List<? extends KTypeParameterImpl>>() { // from class: kotlin.reflect.jvm.internal.KCallableImpl$_typeParameters$1
        {
            super(0);
        }
    ...
    public List<Annotation> getAnnotations() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(listInvoke, "_annotations()");
        return listInvoke;
    }
    ...
    public List<KParameter> getParameters() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(arrayListInvoke, "_parameters()");
    ...
    public KType getReturnType() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(kTypeImplInvoke, "_returnType()");
    ...
    public List<KTypeParameter> getTypeParameters() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(listInvoke, "_typeParameters()");
        return listInvoke;
    }
    ...
    private final R callDefaultMethod(Map<KParameter, ? extends Object> args) throws IllegalCallableAccessException {
