    ...
    public static final <R> KFunction<R> reflect(Function<? extends R> receiver) {
        ...
        if (metadata != null) {
            ...
            if (strArrD1 != null) {
                ...
                int[] iArrMv = metadata.mv();
                JvmMetadataVersion jvmMetadataVersion = new JvmMetadataVersion(Arrays.copyOf(iArrMv, iArrMv.length));
                ...
                SimpleFunctionDescriptor simpleFunctionDescriptor = (SimpleFunctionDescriptor) UtilKt.deserializeToDescriptor(receiver.getClass(), functionComponent2, jvmNameResolverComponent1, new TypeTable(typeTable), jvmMetadataVersion, ReflectLambdaKt$reflect$descriptor$1.INSTANCE);
