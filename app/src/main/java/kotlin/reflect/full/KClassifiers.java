...
public final class KClassifiers {
    ...
    public static final KType createType(final KClassifier receiver, List<KTypeProjection> arguments, boolean z, List<? extends Annotation> annotations) {
        ClassifierDescriptor descriptor;
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(arguments, "arguments");
        Intrinsics.checkParameterIsNotNull(annotations, "annotations");
        KClassifierImpl kClassifierImpl = (KClassifierImpl) (!(receiver instanceof KClassifierImpl) ? null : receiver);
        ...
        return new KTypeImpl(createKotlinType(annotations.isEmpty() ? Annotations.Companion.getEMPTY() : Annotations.Companion.getEMPTY(), typeConstructor, arguments, z), new Function0() { // from class: kotlin.reflect.full.KClassifiers.createType.1
            ...
            public final Void invoke() {
                throw new NotImplementedError("An operation is not implemented: " + ("Java type is not yet supported for types created with createType (classifier = " + receiver + ')'));
            }
        });
    }
    ...
    public static final KType getStarProjectedType(KClassifier receiver) {
        ClassifierDescriptor descriptor;
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        KClassifierImpl kClassifierImpl = (KClassifierImpl) (!(receiver instanceof KClassifierImpl) ? null : receiver);
        if (kClassifierImpl == null || (descriptor = kClassifierImpl.getDescriptor()) == null) {
            return createType$default(receiver, null, false, null, 7, null);
        }
        TypeConstructor typeConstructor = descriptor.getTypeConstructor();
        ...
        return createType$default(receiver, arrayList, false, null, 6, null);
    }
}
