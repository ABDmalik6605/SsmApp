...
public final class KClasses {
    ...
    public static final KType getDefaultType(final KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        SimpleType defaultType = ((KClassImpl) receiver).getDescriptor().getDefaultType();
    ...
    public static final Collection<KCallable<?>> getDeclaredMembers(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        return ((KClassImpl.Data) ((KClassImpl) receiver).getData().invoke()).getDeclaredMembers();
    }
    ...
    public static final Collection<KFunction<?>> getStaticFunctions(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> allStaticMembers = ((KClassImpl.Data) ((KClassImpl) receiver).getData().invoke()).getAllStaticMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final Collection<KFunction<?>> getMemberFunctions(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> allNonStaticMembers = ((KClassImpl.Data) ((KClassImpl) receiver).getData().invoke()).getAllNonStaticMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final Collection<KFunction<?>> getDeclaredFunctions(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> declaredMembers = ((KClassImpl.Data) ((KClassImpl) receiver).getData().invoke()).getDeclaredMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final Collection<KFunction<?>> getDeclaredMemberFunctions(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> declaredNonStaticMembers = ((KClassImpl.Data) ((KClassImpl) receiver).getData().invoke()).getDeclaredNonStaticMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final <T> Collection<KProperty1<T, ?>> getMemberProperties(KClass<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> allNonStaticMembers = ((KClassImpl) receiver).getData().invoke().getAllNonStaticMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final <T> Collection<KProperty1<T, ?>> getDeclaredMemberProperties(KClass<T> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KCallableImpl<?>> declaredNonStaticMembers = ((KClassImpl) receiver).getData().invoke().getDeclaredNonStaticMembers();
        ArrayList arrayList = new ArrayList();
    ...
    public static final List<KClass<?>> getSuperclasses(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        List<KType> supertypes = receiver.getSupertypes();
        ArrayList arrayList = new ArrayList();
    ...
    public static final Collection<KType> getAllSupertypes(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Object objDfs = DFS.dfs(receiver.getSupertypes(), new DFS.Neighbors<KType>() { // from class: kotlin.reflect.full.KClasses$allSupertypes$1
            ...
            public final Iterable<KType> getNeighbors(KType kType) {
                ...
                for (KType kType2 : list) {
                    if (kType2 != null) {
                        KotlinType substituted = typeSubstitutorCreate.substitute(((KTypeImpl) kType2).getType(), Variance.INVARIANT);
                        if (substituted == null) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(objDfs, "DFS.dfs(\n            sup…    }\n            }\n    )");
        return (Collection) objDfs;
    }

    public static final Collection<KClass<?>> getAllSuperclasses(KClass<?> receiver) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Collection<KType> allSupertypes = getAllSupertypes(receiver);
    ...
    public static final boolean isSubclassOf(KClass<?> receiver, final KClass<?> base) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(base, "base");
        if (!Intrinsics.areEqual(receiver, base)) {
            List listListOf = CollectionsKt.listOf(receiver);
            ...
            if (kProperty1 != null) {
                kProperty1 = new DFS.Neighbors() { // from class: kotlin.reflect.full.KClasses$sam$org_jetbrains_kotlin_utils_DFS_Neighbors$0
                    ...
                    public final /* synthetic */ Iterable<N> getNeighbors(N n) {
                        return (Iterable) kProperty1.invoke(n);
                    }
                };
            }
            Boolean boolIfAny = DFS.ifAny(listListOf, (DFS.Neighbors) kProperty1, new Function1<KClass<?>, Boolean>() { // from class: kotlin.reflect.full.KClasses.isSubclassOf.2
                {
                    super(1);
                }
                ...
                public final boolean invoke2(KClass<?> kClass) {
                    return Intrinsics.areEqual(kClass, base);
                }
            });
            Intrinsics.checkExpressionValueIsNotNull(boolIfAny, "DFS.ifAny(listOf(this), …erclasses) { it == base }");
    ...
    public static final boolean isSuperclassOf(KClass<?> receiver, KClass<?> derived) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(derived, "derived");
        return isSubclassOf(derived, receiver);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> T cast(KClass<T> receiver, Object obj) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        ...
        throw new TypeCastException("Value cannot be cast to " + receiver.getQualifiedName());
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> T safeCast(KClass<T> receiver, Object obj) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        if (!receiver.isInstance(obj)) {
            return null;
        }
