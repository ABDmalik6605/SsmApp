...
public final class DurationKt {
    ...
    private static final long m1505timesmvk6XK0(int i, long j) {
        return Duration.m1417timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1504timeskIfJnKk(double d, long j) {
        return Duration.m1416timesUwyO8pc(j, d);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1379constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1379constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1379constructorimpl((j << 1) + i);
    }
