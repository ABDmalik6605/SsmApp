...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1372elapsedNowUwyO8pc() {
        return Duration.m1414minusLRDsOJo(this.mark.mo1372elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1373plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1415plusLRDsOJo(getAdjustment(), duration), null);
    }
}
