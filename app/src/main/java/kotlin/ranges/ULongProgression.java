...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1267getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        int iM249constructorimpl = ((((int) ULong.m249constructorimpl(getFirst() ^ ULong.m249constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m249constructorimpl(getLast() ^ ULong.m249constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return ((int) (j ^ (j >>> 32))) + iM249constructorimpl;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m294toStringimpl(getFirst()));
            sb.append("..");
            sb.append((Object) ULong.m294toStringimpl(getLast()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
