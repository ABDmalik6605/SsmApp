...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        ...
        this.writerRunnable = new Runnable() { // from class: okhttp3.internal.ws.-$$Lambda$RealWebSocket$5j0Gd_3CLrkksESm-AqoZ2MkJQM
            @Override // java.lang.Runnable
            public final void run() throws IOException {
                this.f$0.lambda$new$0$RealWebSocket();
            }
        };
    }

    public /* synthetic */ void lambda$new$0$RealWebSocket() throws IOException {
        do {
            try {
            } catch (IOException e) {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request requestBuild = this.originalRequest.newBuilder().header(HttpHeaders.UPGRADE, "websocket").header(HttpHeaders.CONNECTION, HttpHeaders.UPGRADE).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
