...
public final class RealConnectionPool {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: okhttp3.internal.connection.-$$Lambda$RealConnectionPool$IlX_zHTDM1o4DMNAF0yuZyL86PI
        @Override // java.lang.Runnable
        public final void run() throws IOException {
            this.f$0.lambda$new$0$RealConnectionPool();
        }
    };
    private final Deque<RealConnection> connections = new ArrayDeque();
    final RouteDatabase routeDatabase = new RouteDatabase();

    public /* synthetic */ void lambda$new$0$RealConnectionPool() throws IOException {
        while (true) {
