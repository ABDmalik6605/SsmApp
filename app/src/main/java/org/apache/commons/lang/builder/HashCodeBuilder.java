...
public class HashCodeBuilder {
    ...
    public static int reflectionHashCode(int i, int i2, Object obj, boolean z, Class cls, String[] strArr) {
        ...
        reflectionAppend(obj, superclass, hashCodeBuilder, z, strArr);
    ...
    static void register(Object obj) {
        Class clsClass$ = class$org$apache$commons$lang$builder$HashCodeBuilder;
        if (clsClass$ == null) {
            clsClass$ = class$("org.apache.commons.lang.builder.HashCodeBuilder");
            class$org$apache$commons$lang$builder$HashCodeBuilder = clsClass$;
        }
