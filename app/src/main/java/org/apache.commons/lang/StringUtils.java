...
public class StringUtils {
    ...
    */
    ...
    public static String replace(String str, String str2, String str3, int i) {
        ...
        while (iIndexOf != -1) {
            strBuilder.append(str.substring(i2, iIndexOf)).append(str3);
            i2 = iIndexOf + length;
            i--;
            if (i == 0) {
                break;
    ...
    public static String reverseDelimitedString(String str, String str2) {
        ...
        ArrayUtils.reverse(strArrSplit);
        if (str2 == null) {
            return join((Object[]) strArrSplit, ' ');
        }
        return join(strArrSplit, str2);
    }
        ...
        if (strArr != null && strArr.length > 1) {
            ...
            for (int i = 0; i < length; i++) {
                if (strArr[i] == null) {
                    ...
                    iMin = Math.min(strArr[i].length(), iMin);
    ...
    public static String normalizeSpace(String str) {
        ...
        for (int i = 0; i < strStrip.length(); i++) {
            ...
            if (Character.isWhitespace(cCharAt)) {
                if (i > 0 && !Character.isWhitespace(strStrip.charAt(i - 1))) {
                    strBuilder.append(' ');
                }
            } else {
                strBuilder.append(cCharAt);
